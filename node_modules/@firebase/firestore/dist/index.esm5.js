...
import { XhrIo as D, EventType as x, ErrorCode as _, createWebChannelTransport as N, getStatEventTarget as A, FetchXmlHttpFactory as C, WebChannel as k, Event as O, Stat as V } from "@firebase/webchannel-wrapper";

var L = "@firebase/firestore", R = /** @class */ function() {
    function t(t) {
        this.uid = t;
    }
...
function U(t) {
    ...
    if (P.logLevel <= h.DEBUG) {
        var i = e.map(K);
        P.debug.apply(P, r([ "Firestore (" + M + "): " + t ], i));
    }
}
...
function B(t) {
    ...
    if (P.logLevel <= h.ERROR) {
        var i = e.map(K);
        P.error.apply(P, r([ "Firestore (" + M + "): " + t ], i));
    }
}
 ...
 */ function G(t) {
    ...
    if (P.logLevel <= h.WARN) {
        var i = e.map(K);
        P.warn.apply(P, r([ "Firestore (" + M + "): " + t ], i));
    }
}
 ...
 */ var H = {
    ...
    return t.prototype.start = function(t, r) {
        ...
        // request is outstanding.
            ...
            t.getToken()) : n ? (Q("string" == typeof n.accessToken), new Z(n.accessToken, t.currentUser)) : null;
    ...
    t.prototype.u = function() {
        ...
        return Q(null === t || "string" == typeof t), new R(t);
    }, t;
}(), et = /** @class */ function() {
    function t(t, e, n, r) {
        this.h = t, this.l = e, this.m = n, this.g = r, this.type = "FirstParty", this.user = R.FIRST_PARTY, 
        this.p = new Map
    ...
    return t.prototype.I = function() {
        ...
        Q(!("object" != typeof this.h || null === this.h || !this.h.auth || !this.h.auth.getAuthHeaderValueForFirstParty)), 
    ...
    function t(t, e, n, r) {
        this.h = t, this.l = e, this.m = n, this.g = r;
    }
    return t.prototype.getToken = function() {
        return Promise.resolve(new et(this.h, this.l, this.m, this.g));
    ...
    return t.prototype.start = function(t, e) {
        var n = this, r = function(t) {
            ...
            var r = t.token !== n.A;
            return n.A = t.token, U("FirebaseAppCheckTokenProvider", "Received " + (r ? "new" : "existing") + " token."), 
        ...
        return this.forceRefresh = !1, this.appCheck ? this.appCheck.getToken(e).then((function(e) {
            return e ? (Q("string" == typeof e.token), t.A = e.token, new rt(e.token)) : null;
        })) : Promise.resolve(null);
    }, t.prototype.invalidateToken = function() {
        this.forceRefresh = !0;
    }, t.prototype.shutdown = function() {
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ var At = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.", Ct = /** @class */ function() {
    function t() {
 ...
 */ var Ot = /** @class */ function() {
    ...
    function t(t, e) {
        ...
        /**
             ...
             */
        this.P = new X, this.transaction.oncomplete = function() {
            n.P.resolve();
        }, this.transaction.onabort = function() {
            e.error ? n.P.reject(new Mt(t, e.error)) : n.P.resolve();
        }, this.transaction.onerror = function(e) {
            var r = Bt(e.target.error);
            n.P.reject(new Mt(t, r));
        };
    }
    return t.open = function(e, n, r, i) {
        ...
        t && this.P.reject(t), this.aborted || (U("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"), 
    ...
    function t(e, n, r) {
        ...
        // log on 12.2.
        12.2 === t.D(d()) && B("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    ...
    /** Returns true if IndexedDB is available in the current environment. */ t.C = function() {
        ...
        // Check the UA string to find out the browser.
                var e = d(), n = t.D(e), r = 0 < n && n < 10, i = t.k(e), o = 0 < i && i < 4.5;
        // IE 10
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    e = this, [ 4 /*yield*/ , new Promise((function(e, n) {
                        ...
                        i.onsuccess = function(t) {
                            ...
                            r.S.$(e, i.transaction, t.oldVersion, r.version).next((function() {
                  ...
                  case 2:
                    return [ 2 /*return*/ , (this.B && (this.db.onversionchange = function(t) {
                        return r.B(t);
                    }), this.db) ];
                }
            }));
                    ...
                    e = "readonly" === r, u = 0, s = function() {
                        ...
                        return n(this, (function(n) {
                            switch (n.label) {
                              ...
                              case 1:
                                return n.trys.push([ 1, 4, , 5 ]), [ 4 /*yield*/ , a.F(t) ];
 ...
 */ var Ft = /** @class */ function() {
    ...
    t.prototype.J = function(t, e) {
        ...
        n.X = !1;
        var r = this.cursor(n);
        return this.H(r, (function(t, e, n) {
            return n.delete();
        }));
        ...
        return new Ot((function(r, i) {
            t.onerror = function(t) {
                ...
                if (i) {
                    ...
                    o.isDone ? r() : null === o.G ? i.continue() : i.continue(o.G);
                } else r();
            };
        })).next((function() {
            return Ot.waitFor(n);
...
/** This class is responsible for the scheduling of Index Backfiller. */ var Gt = /** @class */ function() {
    function t(t, e) {
            ...
            return e(r, void 0, void 0, (function() {
                ...
                return n(this, (function(n) {
                    switch (n.label) {
                      ...
                      case 3:
                        return Pt(i = n.sent()) ? (U("IndexBackiller", "Ignoring IndexedDB error during index backfill: ", i), 
                        [ 3 /*break*/ , 6 ]) : [ 3 /*break*/ , 4 ];
    ...
    /** Returns the next offset based on the provided documents. */ t.prototype.ot = function(t, e) {
        var n = t;
...
var Ht = /** @class */ function() {
    function t(t, e) {
        this.comparator = t, this.root = e || Xt.EMPTY;
    }
    // Returns a copy of the map, with the specified key/value added or replaced.
        return t.prototype.insert = function(e, n) {
        return new t(this.comparator, this.root.insert(e, n, this.comparator).copy(null, null, Xt.BLACK, null, null));
    }, 
    // Returns a copy of the map, with the specified key removed.
    t.prototype.remove = function(e) {
        return new t(this.comparator, this.root.remove(e, this.comparator).copy(null, null, Xt.BLACK, null, null));
    }, 
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
Xt.EMPTY = null, Xt.RED = !0, Xt.BLACK = !1, 
// end LLRBEmptyNode
Xt.EMPTY = new (/** @class */ function() {
    function t() {
        this.size = 0;
    }
 ...
 */ var te = /** @class */ function() {
    ...
    t.prototype.unionWith = function(e) {
        for (var n = new Zt(yt.comparator), r = 0, i = this.fields; r < i.length; r++) {
            var o = i[r];
            n = n.add(o);
        }
...
/** Extracts the backend's type order for the provided value. */ function me(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? se(t) ? 4 /* ServerTimestampValue */ : ke(t) ? 9007199254740991 /* MaxValue */ : 10 /* ObjectValue */ : j();
}
...
/** Creates a deep copy of `source`. */ function Ce(t) {
    ...
    if (t.mapValue) {
        ...
        return zt(t.mapValue.fields, (function(t, n) {
            return e.mapValue.fields[t] = Ce(n);
        })), e;
    }
    if (t.arrayValue) {
        for (var n = {
        ...
        }, r = 0; r < (t.arrayValue.values || []).length; ++r) n.arrayValue.values[r] = Ce(t.arrayValue.values[r]);
        return n;
    }
    return Object.assign({}, t);
}

/** Returns true if the Value represents the canonical {@link #MAX_VALUE} . */ function ke(t) {
 ...
 */ var Me = /** @class */ function() {
    ...
    t.prototype.set = function(t, e) {
        this.getFieldsMap(t.popLast())[t.lastSegment()] = Ce(e);
    }, 
    /**
    ...
    t.prototype.setAll = function(t) {
        ...
        t.forEach((function(t, o) {
            ...
            t ? r[o.lastSegment()] = Ce(t) : i.push(o.lastSegment());
        }));
...
var Fe = /** @class */ function() {
    ...
    this.startAt = o, this.endAt = u, this.ht = null;
};
...
/** Returns the number of segments of a perfect index for this target. */ var We = /** @class */ function(e) {
     ...
     */    return t(n, e), n.create = function(t, e, r) {
        return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.lt(t, e, r) : new He(t, e, r) : "array-contains" /* ARRAY_CONTAINS */ === e ? new Je(t, r) : "in" /* IN */ === e ? new $e(t, r) : "not-in" /* NOT_IN */ === e ? new tn(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new en(t, r) : new n(t, e, r);
    }, n.lt = function(t, e, n) {
        return "in" /* IN */ === e ? new Ye(t, n) : new Xe(t, n);
    }, n.prototype.matches = function(t) {
        var e = t.data.field(this.field);
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.ft(be(e, this.value)) : null !== e && me(this.value) === me(e) && this.ft(be(e, this.value));
    ...
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t, "in" /* IN */ , n) || this).keys = Ze("in" /* IN */ , n), 
        r;
    }
    return t(n, e), n.prototype.matches = function(t) {
    ...
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t, "not-in" /* NOT_IN */ , n) || this).keys = Ze("not-in" /* NOT_IN */ , n), 
        r;
    }
    return t(n, e), n.prototype.matches = function(t) {
        return !this.keys.some((function(e) {
 ...
 */ function vn(t) {
    ...
    if (null === e._t) {
        ...
        n.isKeyField() || e._t.push(new rn(n)), e._t.push(new rn(yt.keyField(), "asc" /* ASCENDING */)); else {
            ...
            if (!i) {
                ...
                e._t.push(new rn(yt.keyField(), a));
            }
        }
    }
    return e._t;
 ...
 */ function yn(t) {
    var e = W(t);
    if (!e.wt) if ("F" /* First */ === e.limitType) e.wt = Ue(e.path, e.collectionGroup, vn(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
        ...
        // Now return as a LimitType.First query.
                e.wt = Ue(e.path, e.collectionGroup, n, e.filters, e.limit, s, a);
    }
    return e.wt;
}
...
function gn(t, e) {
    return Ge(yn(t), yn(e)) && t.limitType === e.limitType;
}
 ...
 */ function An(t, e, n) {
    ...
    }(n, e) : t instanceof Vn ? Ln(t, e) : t instanceof Rn ? Mn(t, e) : function(t, e) {
        // PORTING NOTE: Since JavaScript's integer arithmetic is limited to 53 bit
        // precision and resolves overflows by reducing precision, we do not
        // manually cap overflows at 2^63.
        var n = kn(t, e), r = Fn(n) + Fn(t.yt);
        return De(n) && De(t.yt) ? xn(r) : Dn(t.It, r);
    }(t, e);
}
 ...
 */ function Cn(t, e, n) {
    ...
    // applications.
    return t instanceof Vn ? Ln(t, e) : t instanceof Rn ? Mn(t, e) : n;
}
 ...
 */ function kn(t, e) {
    return t instanceof Pn ? De(n = e) || function(t) {
...
/** Transforms an array value via a union operation. */ function Ln(t, e) {
 ...
 */ function Qn(t, e) {
    ...
    // mask is null when sets or deletes are applied to the current document.
        if (null === e) return t.isNoDocument() ? new rr(t.key, Gn.none()) : new Xn(t.key, t.data, Gn.none());
    for (var n = t.data, r = Me.empty(), i = new Zt(yt.comparator), o = 0, u = e.fields; o < u.length; o++) {
        var s = u[o];
        if (!i.has(s)) {
            var a = n.field(s);
    ...
    return new Zn(t.key, r, new te(i.toArray()), Gn.none());
}
 ...
 */ function zn(t, e, n) {
    t instanceof Xn ? function(t, e, n) {
        // Unlike setMutationApplyToLocalView, if we're applying a mutation to a
        // remote document the server has accepted the mutation so the precondition
        // must have held.
        var r = t.value.clone(), i = $n(t.fieldTransforms, e, n.transformResults);
        r.setAll(i), e.convertToFoundDocument(n.version, r).setHasCommittedMutations();
    }(t, e, n) : t instanceof Zn ? function(t, e, n) {
        if (Kn(t.precondition, e)) {
            var r = $n(t.fieldTransforms, e, n.transformResults), i = e.data;
            i.setAll(Jn(t)), i.setAll(r), e.convertToFoundDocument(n.version, i).setHasCommittedMutations();
 ...
 */ function Wn(t, e, n, r) {
    return t instanceof Xn ? function(t, e, n, r) {
        if (!Kn(t.precondition, e)) 
        ...
        }(t, e, n, r) : t instanceof Zn ? function(t, e, n, r) {
        if (!Kn(t.precondition, e)) return n;
        var i = tr(t.fieldTransforms, r, e), o = e.data;
        return o.setAll(Jn(t)), o.setAll(i), e.convertToFoundDocument(e.version, o).setHasLocalMutations(), 
        null === n ? null : n.unionWith(t.fieldMask.fields).unionWith(t.fieldTransforms.map((function(t) {
            return t.field;
        })));
    }(t, e, n, r) : function(t, e, n) {
        return Kn(t.precondition, e) ? (e.convertToNoDocument(e.version).setHasLocalMutations(), 
        null) : n;
    }(t, e, n);
}
 ...
 */ function Hn(t, e) {
    for (var n = null, r = 0, i = t.fieldTransforms; r < i.length; r++) {
        var o = i[r], u = e.data.field(o.field), s = kn(o.transform, u || null);
        ...
        return void 0 === t && void 0 === e || !(!t || !e) && ct(t, e, (function(t, e) {
            return function(t, e) {
                return t.field.isEqual(e.field) && function(t, e) {
                    return t instanceof Vn && e instanceof Vn || t instanceof Rn && e instanceof Rn ? ct(t.elements, e.elements, ge) : t instanceof Pn && e instanceof Pn ? ge(t.yt, e.yt) : t instanceof On && e instanceof On;
...
var mr = new Ht(mt.comparator), gr = new Zt(mt.comparator);
...
/**
     ...
     */
r) {
    this.Tt = t, this.removedTargetIds = e, this.key = n, this.Et = r;
}, Dr = function(t, e) {
...
/** An RPC error indicating why the watch failed. */ , r) {
    ...
    function t() {
        ...
        this.Pt = ne.EMPTY_BYTE_STRING, this.vt = !1, 
        /**
    ...
    t.prototype.xt = function() {
        var t = wr(), e = wr(), n = wr();
        return this.bt.forEach((function(r, i) {
            switch (i) {
              case 0 /* Added */ :
                t = t.add(r);
                break;
        ...
        })), new Tr(this.Pt, this.vt, t, e, n);
    }, 
    /**
     * Resets the document changes and sets `hasPendingChanges` to false.
     */
    t.prototype.Nt = function() {
        this.Vt = !1, this.bt = Cr();
    ...
    return t.prototype.Gt = function(t) {
        for (var e = 0, n = t.Tt; e < n.length; e++) {
            var r = n[e];
            t.Et && t.Et.isFoundDocument() ? this.Qt(r, t.Et) : this.jt(r, t.key, t.Et);
        }
        for (var i = 0, o = t.removedTargetIds; i < o.length; i++) {
            var u = o[i];
            this.jt(u, t.key, t.Et);
        }
    }, 
    /** Processes and adds the WatchTargetChange to the current set of changes. */ t.prototype.Wt = function(t) {
        var e = this;
        this.forEachTarget(t, (function(n) {
            var r = e.zt(n);
            switch (t.state) {
              case 0 /* NoChange */ :
                e.Ht(n) && r.Ct(t.resumeToken);
                break;
              ...
              case 2 /* Removed */ :
                ...
                // We need to decrement the number of pending acks needed from watch
                // for this targetId.
                r.Ft(), r.St || e.removeTarget(n);
                break;

              case 3 /* Current */ :
                e.Ht(n) && (r.$t(), r.Ct(t.resumeToken));
                break;
    ...
    t.prototype.forEachTarget = function(t, e) {
        var n = this;
        t.targetIds.length > 0 ? t.targetIds.forEach(e) : this.Lt.forEach((function(t, r) {
            n.Ht(r) && e(r);
        }));
    }, 
    /**
    ...
    t.prototype.Yt = function(t) {
        var e = t.targetId, n = t.At.count, r = this.Xt(e);
        if (r) {
            var i = r.target;
            if (Ke(i)) if (0 === n) {
                ...
                // queries.
                var o = new mt(i.path);
                this.jt(e, o, Fe.newNoDocument(o, ft.min()));
            } else Q(1 === n); else this.Zt(e) !== n && (
    ...
    t.prototype.te = function(t) {
        ...
        this.Lt.forEach((function(r, i) {
            var o = e.Xt(i);
            if (o) {
                if (r.current && Ke(o.target)) {
                    ...
                    null !== e.Ut.get(u) || e.ee(i, u) || e.jt(i, u, Fe.newNoDocument(u, t));
                }
        ...
        // client.
                this.qt.forEach((function(t, n) {
            var i = !0;
            n.forEachWhile((function(t) {
                var n = e.Xt(t);
                return !n || 2 /* LimboResolution */ === n.purpose || (i = !1, !1);
            })), i && (r = r.add(t));
        })), this.Ut.forEach((function(e, n) {
            return n.setReadTime(t);
        }));
        var i = new Er(t, n, this.Kt, this.Ut, r);
        return this.Ut = lr(), this.qt = Ar(), this.Kt = new Zt(at), i;
    }, 
    /**
    ...
    t.prototype.Qt = function(t, e) {
        if (this.Ht(t)) {
            var n = this.ee(t, e.key) ? 2 /* Modified */ : 0 /* Added */;
    ...
    t.prototype.jt = function(t, e, n) {
        if (this.Ht(t)) {
            var r = this.zt(t);
            this.ee(t, e) ? r.kt(e, 1 /* Removed */) : 
            // The document may have entered and left the target before we raised a
            // snapshot, so we can just ignore the change.
            r.Mt(e), this.qt = this.qt.insert(e, this.ne(e).delete(t)), n && (this.Ut = this.Ut.insert(e, n));
        }
    ...
    t.prototype.Ot = function(t) {
        ...
        var e = this.Lt.get(t);
        return e || (e = new _r, this.Lt.set(t, e)), e;
    }, t.prototype.ne = function(t) {
        var e = this.qt.get(t);
        return e || (e = new Zt(at), this.qt = this.qt.insert(t, e)), e;
    }, 
    /**
    ...
    t.prototype.Jt = function(t) {
        var e = this;
        this.Lt.set(t, new _r), this.Bt.getRemoteKeysForTarget(t).forEach((function(n) {
 ...
 */ function Mr(t, e) {
    return Lr(t, e.toTimestamp());
}

function Pr(t) {
    return Q(!!t), ft.fromTimestamp(function(t) {
        var e = ie(t);
        return new ht(e.seconds, e.nanos);
    }(t));
}
...
function Kr(t) {
    ...
    // in the local target cache.
        return 4 === e.length ? pt.emptyPath() : Qr(e);
}
...
function Wr(t, e, n) {
    var r = Br(t, e.name), i = Pr(e.updateTime), o = new Me({
        mapValue: {
            fields: e.fields
        }
    }), u = Fe.newFoundDocument(r, i, o);
...
function Yr(t, e) {
    var n = e.currentDocument ? function(t) {
        return void 0 !== t.updateTime ? Gn.updateTime(Pr(t.updateTime)) : void 0 !== t.exists ? Gn.exists(t.exists) : Gn.none();
    }(e.currentDocument) : Gn.none(), r = e.updateTransforms ? e.updateTransforms.map((function(e) {
        return function(t, e) {
            var n = null;
            if ("setToServerValue" in e) Q("REQUEST_TIME" === e.setToServerValue), n = new On; else if ("appendMissingElements" in e) {
                var r = e.appendMissingElements.values || [];
                n = new Vn(r);
            } else if ("removeAllFromArray" in e) {
                var i = e.removeAllFromArray.values || [];
                n = new Rn(i);
            } else "increment" in e ? n = new Pn(t, e.increment) : j();
    ...
    if (e.update) {
        e.update.name;
        var i = Br(t, e.update.name), o = new Me({
            mapValue: {
        ...
        if (e.updateMask) {
            ...
            return new Zn(i, o, u, n, r);
        }
        return new Xn(i, o, n, r);
    }
    if (e.delete) {
        var s = Br(t, e.delete);
        return new rr(s, n);
...
function Zr(t, e) {
    ...
    null !== e.collectionGroup ? (n.parent = Gr(t, r), n.structuredQuery.from = [ {
        collectionId: e.collectionGroup,
        allDescendants: !0
    } ]) : (n.parent = Gr(t, r.popLast()), n.structuredQuery.from = [ {
...
function Jr(t) {
    var e = Kr(t.parent), n = t.structuredQuery, r = n.from ? n.from.length : 0, i = null;
    if (r > 0) {
        Q(1 === r);
        var o = n.from[0];
 ...
 */ function hi(t) {
    ...
    var e = t.length;
    if (Q(e >= 2), 2 === e) return Q("" === t.charAt(0) && "" === t.charAt(1)), pt.emptyPath();
 ...
 */ var Pi = /** @class */ function() {
    ...
    return t.prototype.applyToRemoteDocument = function(t, e) {
        for (var n = e.mutationResults, r = 0; r < this.mutations.length; r++) {
            ...
            i.key.isEqual(t.key) && zn(i, t, n[r]);
        }
    }, 
    /**
    ...
    t.prototype.applyToLocalDocumentSet = function(t, e) {
        ...
        // to O(n).
            ...
            var o = t.get(i.key), u = o.overlayedDocument, s = n.applyToLocalView(u, o.mutatedFields), a = Qn(u, 
...
/** Encodes a document for storage locally. */ function Gi(t, e) {
    var n = e.key, r = {
    ...
    if (e.isFoundDocument()) r.document = function(t, e) {
        return {
            ...
            updateTime: Lr(t, e.version.toTimestamp())
        };
...
/** Decodes a DbMutationBatch into a MutationBatch */ function zi(t, e) {
    ...
    return new Pi(e.batchId, s, n, u);
}

/** Decodes a DbTarget into TargetData */ function Wi(t) {
    var e, n, r = Qi(t.readTime), i = void 0 !== t.lastLimboFreeSnapshotVersion ? Qi(t.lastLimboFreeSnapshotVersion) : ft.min();
    return void 0 !== t.query.documents ? (Q(1 === (n = t.query).documents.length), 
    e = yn(ln(Kr(n.documents[0])))) : e = function(t) {
        return yn(Jr(t));
...
function Hi(t, e) {
    ...
    n = Ke(e.target) ? Xr(t.re, e.target) : Zr(t.re, e.target);
...
/** Encodes a DbDocumentOverlay object to an Overlay model object. */ function Xi(t, e) {
    return new qi(e.largestBatchId, Yr(t.re, e.overlayMutation));
}
 ...
 */ var no = /** @class */ function() {
    ...
    return t.oe = function(e, n) {
        ...
        var n = this;
        return ro(t).get(Zi(this.userId, e)).next((function(t) {
            return t ? Xi(n.It, t) : null;
        }));
        ...
        return i.forEach((function(e) {
            ...
            /*lowerOpen=*/ !1, 
            /*upperOpen=*/ !0);
            o.push(ro(t).Y("collectionPathOverlayIndex", i));
        })), Ot.waitFor(o);
        ...
        /*lowerOpen=*/ !0);
        return ro(t).W("collectionPathOverlayIndex", u).next((function(t) {
            for (var e = 0, n = t; e < n.length; e++) {
                var o = n[e], u = Xi(r.It, o);
                i.set(u.getKey(), u);
            }
            return i;
        }));
        ...
        return ro(t).put(function(t, e, n) {
            ...
            return r[0], {
                ...
                overlayMutation: Hr(t.re, n.mutation)
            };
...
/** Firestore index value writer.  */ var io = /** @class */ function() {
    ...
    /** Writes an index value.  */    return t.prototype.ce = function(t, e) {
        this.ae(t, e), 
        ...
        e.fe(t.booleanValue ? 1 : 0); else if ("integerValue" in t) this.le(e, 15), e.fe(oe(t.integerValue)); else if ("doubleValue" in t) {
            var n = oe(t.doubleValue);
            isNaN(n) ? this.le(e, 13) : (this.le(e, 15), de(n) ? 
            // -0.0, 0 and 0.0 are all considered the same
            e.fe(0) : e.fe(n));
        } else if ("timestampValue" in t) {
            var r = t.timestampValue;
            this.le(e, 20), "string" == typeof r ? e.de(r) : (e.de("" + (r.seconds || "")), 
            e.fe(r.nanos || 0));
        } else if ("stringValue" in t) this._e(t.stringValue, e), this.we(e); else if ("bytesValue" in t) this.le(e, 30), 
        e.me(ue(t.bytesValue)), this.we(e); else if ("referenceValue" in t) this.ge(t.referenceValue, e); else if ("geoPointValue" in t) {
            var i = t.geoPointValue;
            this.le(e, 45), e.fe(i.latitude || 0), e.fe(i.longitude || 0);
        } else "mapValue" in t ? ke(t) ? this.le(e, Number.MAX_SAFE_INTEGER) : (this.ye(t.mapValue, e), 
        this.we(e)) : "arrayValue" in t ? (this.pe(t.arrayValue, e), this.we(e)) : j();
        ...
        var n = this;
        this.le(e, 37), mt.fromName(t).path.forEach((function(t) {
            n.le(e, 60), n.Ie(t, e);
        }));
...
var so = /** @class */ function() {
    ...
    return t.prototype.Ee = function(t) {
        ...
        for (var e = t[Symbol.iterator](), n = e.next(); !n.done; ) this.Pe(n.value), n = e.next();
        this.ve();
    }, 
    /** Writes utf8 bytes into this byte sequence, ascending. */ t.prototype.Ve = function(t) {
        for (var e = 0, n = t; e < n.length; e++) {
    ...
    /** Writes utf8 bytes into this byte sequence, descending */ t.prototype.Se = function(t) {
        for (var e = 0, n = t; e < n.length; e++) {
            var r = n[e], i = r.charCodeAt(0);
            if (i < 128) this.Pe(i); else if (i < 2048) this.Pe(960 | i >>> 6), this.Pe(128 | 63 & i); else if (r < "\ud800" || "\udbff" < r) this.Pe(480 | i >>> 12), 
            this.Pe(128 | 63 & i >>> 6), this.Pe(128 | 63 & i); else {
                var o = r.codePointAt(0);
                this.Pe(240 | o >>> 18), this.Pe(128 | 63 & o >>> 12), this.Pe(128 | 63 & o >>> 6), 
                this.Pe(128 | 63 & o);
            }
        }
        this.ve();
    ...
    /** Makes a copy of the encoded bytes in this buffer.  */ t.prototype.$e = function() {
    ...
    /** Writes a single byte ascending to the buffer. */ t.prototype.Ae = function(t) {
        var e = 255 & t;
        0 === e ? (this.Me(0), this.Me(255)) : 255 === e ? (this.Me(255), this.Me(0)) : this.Me(e);
    }, 
    /** Writes a single byte descending to the buffer.  */ t.prototype.Pe = function(t) {
        var e = 255 & t;
    ...
    return t.prototype.me = function(t) {
        this.Be.Ee(t);
    }, t.prototype.de = function(t) {
        this.Be.Ve(t);
    }, t.prototype.fe = function(t) {
    ...
    function t() {
        this.Be = new so, this.Le = new ao(this.Be), this.Ue = new co(this.Be);
    }
 ...
 */ var vo = /** @class */ function() {
     ...
     */    return t.prototype.We = function(t) {
        ...
        for (var n = bt(t), r = 0, i = 0; r < n.length && this.ze(n[r]); ++r) ;
        ...
        // filter and the first orderBy clause.
                if (void 0 !== this.je) {
            var o = n[r];
            if (!this.He(this.je, o) || !this.Je(this.Ge[i++], o)) return !1;
            ++r;
        }
        ...
        // orderBy.
                for (;r < n.length; ++r) {
            var u = n[r];
            if (i >= this.Ge.length || !this.Je(this.Ge[i++], u)) return !1;
        }
        return !0;
    }, t.prototype.ze = function(t) {
        for (var e = 0, n = this.Qe; e < n.length; e++) {
            var r = n[e];
            if (this.He(r, t)) return !0;
        }
        return !1;
    ...
    return t.prototype.addToCollectionParentIndex = function(t, e) {
        return this.Ye.add(e), Ot.resolve();
    }, t.prototype.getCollectionParents = function(t, e) {
        return Ot.resolve(this.Ye.getEntries(e));
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e] || new Zt(pt.comparator), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new Zt(pt.comparator)).toArray();
    }, t;
    ...
    return t.prototype.addToCollectionParentIndex = function(t, e) {
        ...
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return bo(t).W(r).next((function(t) {
        ...
        if (e.indexState) {
            ...
            return o.next((function(t) {
                u.put(Ji(t, n.user, e.indexState.sequenceNumber, e.indexState.offset));
            }));
        }
        return o.next();
    }, t.prototype.deleteFieldIndex = function(t, e) {
        ...
        return Ot.forEach(this.tn(e), (function(e) {
                ...
                return Ot.forEach(o, (function(i, o) {
                    ...
                    var a = function(t, e) {
                        ...
                        for (var n = [], r = !0, i = 0, o = bt(e); i < o.length; i++) {
                            var u = o[i], s = 0 /* ASCENDING */ === u.kind ? Qe(t, u.fieldPath, t.startAt) : ze(t, u.fieldPath, t.startAt);
                        ...
                        // endAt.
                        for (var n = [], r = !0, i = 0, o = bt(e); i < o.length; i++) {
                            var u = o[i], s = 0 /* ASCENDING */ === u.kind ? ze(t, u.fieldPath, t.endAt) : Qe(t, u.fieldPath, t.endAt);
                            n.push(s.value), r && (r = s.inclusive);
                        }
                        return new nn(n, r);
     ...
     * bounds.
     */
    t.prototype.rn = function(t, e, n, r, i, o, u) {
        for (var s = this, a = (null != e ? e.length : 1) * Math.max(n.length, i.length), c = a / (null != e ? e.length : 1), l = [], h = function(a) {
            var h = e ? f.on(e[a / c]) : go, d = f.un(t, h, n[a % c], r), p = f.cn(t, h, i[a % c], o), v = u.map((function(e) {
                return s.un(t, h, e, 
                /* inclusive= */ !0);
            }));
    ...
    /** Generates the lower bound for `arrayValue` and `directionalValue`. */ t.prototype.un = function(t, e, n, r) {
        var i = new ho(t, mt.empty(), e, n);
        return r ? i : i.Ke();
    }, 
    /** Generates the upper bound for `arrayValue` and `directionalValue`. */ t.prototype.cn = function(t, e, n, r) {
        var i = new ho(t, mt.empty(), e, n);
        return r ? i.Ke() : i;
        ...
        return this.getFieldIndexes(t, r).next((function(t) {
            ...
            var e = null, r = 0, i = t; r < i.length; r++) {
                var o = i[r];
                n.We(o) && (!e || o.fields.length > e.fields.length) && (e = o);
            }
            return e;
        }));
    }, t.prototype.getIndexType = function(t, e) {
        ...
        return Ot.forEach(this.tn(e), (function(e) {
            return n.en(t, e).next((function(t) {
                t ? 0 /* NONE */ !== r && t.fields.length < function(t) {
                    for (var e = new Zt(yt.comparator), n = !1, r = 0, i = t.filters; r < i.length; r++) {
                        var o = i[r];
    ...
    /** Encodes a single value to the ascending index format. */ t.prototype.on = function(t) {
        var e = new lo;
        return io.Te.ce(t, e.qe(0 /* ASCENDING */)), e.$e();
    }, 
    /**
    ...
    t.prototype.hn = function(t, e) {
        var n = new lo;
        return io.Te.ce(Se(this.databaseId, e), n.qe(function(t) {
            var e = bt(t);
    ...
    t.prototype.sn = function(t, e, n) {
        ...
        for (var i = 0, o = 0, u = bt(t); o < u.length; o++) for (var s = u[o], a = n[i++], c = 0, l = r; c < l.length; c++) {
            var h = l[c];
            if (this.ln(e, s.fieldPath) && xe(a)) r = this.fn(r, s, a); else {
                var f = h.qe(s.kind);
                io.Te.ce(a, f);
            }
        }
    ...
    /** Returns the byte representation for the provided encoders. */ t.prototype.dn = function(t) {
        for (var e = [], n = 0; n < t.length; ++n) e[n] = t[n].$e();
        return e;
    }, 
    /**
    ...
    t.prototype.fn = function(t, e, n) {
        for (var i = r([], t), o = [], u = 0, s = n.arrayValue.values || []; u < s.length; u++) for (var a = s[u], c = 0, l = i; c < l.length; c++) {
            var h = l[c], f = new lo;
            f.seed(h.$e()), io.Te.ce(a, f.qe(e.kind)), o.push(f);
        }
        return o;
        ...
        return (e ? r.W("collectionGroupIndex", IDBKeyRange.bound(e, e)) : r.W()).next((function(t) {
            ...
            return Ot.forEach(t, (function(t) {
                return i.get([ t.indexId, n.uid ]).next((function(n) {
                    e.push(function(t, e) {
                        var n = e ? new St(e.sequenceNumber, new _t(Qi(e.readTime), new mt(hi(e.documentKey)), e.largestBatchId)) : St.empty(), r = t.fields.map((function(t) {
                            var e = t[0], n = t[1];
        ...
        return this._n(t).next((function(t) {
            return i.W("collectionGroupIndex", IDBKeyRange.bound(e, e)).next((function(e) {
                return Ot.forEach(e, (function(e) {
                    return o.put(Ji(e.indexId, r.user, t, n));
                }));
            }));
        }));
    }, t.prototype.updateIndexEntries = function(t, e) {
            ...
            return (o ? Ot.resolve(o) : n.getFieldIndexes(t, e.collectionGroup)).next((function(o) {
                return r.set(e.collectionGroup, o), Ot.forEach(o, (function(r) {
                    return n.wn(t, e, r).next((function(e) {
                        var o = n.mn(i, r);
                        return e.isEqual(o) ? Ot.resolve() : n.gn(t, i, r, e, o);
                    }));
                }));
            }));
        }));
        ...
        return Io(t).delete([ r.indexId, this.uid, r.arrayValue, r.directionalValue, this.hn(n, e.key), e.key.path.toArray() ]);
    }, t.prototype.wn = function(t, e, n) {
        var r = Io(t), i = new Zt(fo);
        return r.Z({
    ...
    /** Creates the index entries for the given document. */ t.prototype.mn = function(t, e) {
        var n = new Zt(fo), r = this.an(e, t);
        if (null == r) return n;
        var i = wt(e);
        if (null != i) {
            ...
            if (xe(o)) for (var u = 0, s = o.arrayValue.values || []; u < s.length; u++) {
                var a = s[u];
                n = n.add(new ho(e.indexId, t.key, this.on(a), r));
            }
     ...
     * entries.
     */
    t.prototype.gn = function(t, e, n, r, i) {
        var o = this;
        ...
        return function(t, e, n, r, i) {
            ...
            // `comparator`.
            for (var o = t.getIterator(), u = e.getIterator(), s = $t(o), a = $t(u); s || a; ) {
                var c = !1, l = !1;
                if (s && a) {
                    var h = n(s, a);
                    h < 0 ? 
                ...
                c ? (r(a), a = $t(u)) : l ? (i(s), s = $t(o)) : (s = $t(o), a = $t(u));
            }
        }(r, i, fo, (
        /* onAdd= */ function(r) {
            u.push(o.yn(t, e, n, r));
    ...
    t.prototype.createRange = function(t, e, n) {
        ...
        var n = this;
        return Ot.mapArray(this.tn(e), (function(e) {
            return n.en(t, e).next((function(t) {
                return t || j();
            }));
        })).next(So);
...
var Ao = /** @class */ function() {
     ...
     */
    t, e, n, r) {
        this.userId = t, this.It = e, this.indexManager = n, this.referenceDelegate = r, 
        /**
    ...
    return t.oe = function(e, n, r, i) {
        ...
        return Q("" !== e.uid), new t(e.isAuthenticated() ? e.uid : "", n, r, i);
        ...
        return u.add({}).next((function(s) {
            Q("number" == typeof s);
            for (var a = new Pi(s, e, n, r), c = function(t, e, n) {
            ...
            }(i.It, i.userId, a), l = [], h = new Zt((function(t, e) {
        ...
        var n = this;
        return ko(t).get(e).next((function(t) {
            return t ? (Q(t.userId === n.userId), zi(n.It, t)) : null;
        }));
    }, 
    /**
    ...
    t.prototype.Tn = function(t, e) {
        var n = this;
        return this.In[e] ? Ot.resolve(this.In[e]) : this.lookupMutationBatch(t, e).next((function(t) {
            if (t) {
                var r = t.keys();
                return n.In[e] = r, r;
            }
        ...
        return ko(t).Z({
            ...
            e.userId === n.userId && (Q(e.batchId >= r), o = zi(n.It, e)), i.done();
        })).next((function() {
            return o;
        }));
        ...
        return ko(t).W("userMutationsIndex", n).next((function(t) {
        ...
        // the given documentKey.
            ...
            return ko(t).get(c).next((function(t) {
                if (!t) throw j();
                Q(t.userId === n.userId), o.push(zi(n.It, t));
            }));
            u.done();
        })).next((function() {
            return o;
        ...
        var n = this, r = new Zt(at), i = [];
        return e.forEach((function(e) {
            var o = di(n.userId, e.path), u = IDBKeyRange.lowerBound(o), s = Oo(t).Z({
                range: u
            }, (function(t, i, o) {
        ...
        var n = this, r = e.path, i = r.length + 1, o = di(this.userId, r), u = IDBKeyRange.lowerBound(o), s = new Zt(at);
        return Oo(t).Z({
            range: u
        }, (function(t, e, o) {
        ...
        return e.forEach((function(e) {
            i.push(ko(t).get(e).next((function(t) {
                if (null === t) throw j();
                Q(t.userId === n.userId), r.push(zi(n.It, t));
            })));
        })), Ot.waitFor(i).next((function() {
            return r;
        }));
        ...
        var n = this;
        return _o(t.ie, this.userId, e).next((function(r) {
 ...
 */ var Lo = /** @class */ function() {
    ...
    // out to have a meaningful performance impact.
        ...
        return this.Vn(t).next((function(n) {
            var r = new Lo(n.highestTargetId);
        ...
        var r = this;
        return this.Vn(t).next((function(i) {
            return i.highestListenSequenceNumber = e, n && (i.lastRemoteSnapshotVersion = n.toTimestamp()), 
            e > i.highestListenSequenceNumber && (i.highestListenSequenceNumber = e), r.Sn(t, i);
        }));
    }, t.prototype.addTargetData = function(t, e) {
        var n = this;
        return this.Dn(t, e).next((function() {
            return n.Vn(t).next((function(r) {
                return r.targetCount += 1, n.Cn(e, r), n.Sn(t, r);
            }));
        }));
        ...
        return this.removeMatchingKeysForTargetId(t, e.targetId).next((function() {
            return Mo(t).delete(e.targetId);
        })).next((function() {
            return n.Vn(t);
        })).next((function(e) {
            return Q(e.targetCount > 0), e.targetCount -= 1, n.Sn(t, e);
        }));
    }, 
    /**
     ...
     */
    t.prototype.forEachTarget = function(t, e) {
        return Mo(t).Z((function(t, n) {
            var r = Wi(n);
            e(r);
        }));
    }, t.prototype.Vn = function(t) {
        return Po(t).get("targetGlobalKey").next((function(t) {
            return Q(null !== t), t;
        }));
    }, t.prototype.Sn = function(t, e) {
        return Po(t).put("targetGlobalKey", e);
    }, t.prototype.Dn = function(t, e) {
        return Mo(t).put(Hi(this.It, e));
    }, 
    /**
    ...
    t.prototype.Cn = function(t, e) {
        ...
        var n = Fo(t), r = IDBKeyRange.bound([ e ], [ e + 1 ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return n.delete(r);
    ...
    t.prototype.se = function(t, e) {
        return Mo(t).get(e).next((function(t) {
            return t ? Wi(t) : null;
        }));
    }, t;
}();
 ...
 */ var Uo = /** @class */ function() {
    function t(t) {
        this.xn = t, this.buffer = new Zt(qo), this.Nn = 0;
    }
    ...
    return t.prototype.start = function() {
        ...
        var r = this;
        U("LruGarbageCollector", "Garbage collection scheduled in " + t + "ms"), this.On = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection" /* LruGarbageCollection */ , t, (function() {
            return e(r, void 0, void 0, (function() {
                var t;
                return n(this, (function(e) {
                    switch (e.label) {
                      case 0:
                        this.On = null, e.label = 1;
                      ...
                      case 3:
                        return Pt(t = e.sent()) ? (U("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", t), 
                        [ 3 /*break*/ , 6 ]) : [ 3 /*break*/ , 4 ];
    ...
    return t.prototype.calculateTargetCount = function(t, e) {
        ...
        var n = this;
        if (0 === e) return Ot.resolve(jt.at);
        var r = new Uo(e);
        return this.$n.forEachTarget(t, (function(t) {
            return r.Mn(t.sequenceNumber);
        })).next((function() {
            return n.$n.Ln(t, (function(t) {
                return r.Mn(t);
            }));
        })).next((function() {
            return r.maxValue;
    ...
    t.prototype.Gn = function(t, e) {
        return function(t, e) {
            var n = !1;
            return Vo(t).tt((function(r) {
                return Co(t, r, e).next((function(t) {
        ...
        return this.Kn(t, (function(u, s) {
            if (s <= e) {
                var a = n.Gn(t, u).next((function(e) {
                    if (!e) 
                    // Our size accounting requires us to read all documents before
                    // removing them.
                    return o++, r.getEntry(t, u).next((function() {
                        return r.removeEntry(u, ft.min()), Fo(t).delete([ 0, ai(u.path) ]);
                    }));
                }));
                i.push(a);
            }
 ...
 */ var Qo = /** @class */ function() {
    ...
    t.prototype.removeEntry = function(t, e) {
        this.assertNotApplied(), this.changes.set(t, Fe.newInvalidDocument(t).setReadTime(e));
    }, 
    /**
 ...
 */
    ...
    t.prototype.updateMetadata = function(t, e) {
        ...
        var n = this, r = Fe.newInvalidDocument(e);
        return Xo(t).Z({
            index: "documentKeyIndex",
    ...
    t.prototype.Wn = function(t, e) {
        var n = this, r = {
            size: 0,
            document: Fe.newInvalidDocument(e)
        };
        return Xo(t).Z({
            index: "documentKeyIndex",
            range: IDBKeyRange.only(Zo(e))
    ...
    t.prototype.Hn = function(t, e) {
        ...
        var o = IDBKeyRange.bound(Zo(i.first()), Zo(i.last())), u = i.getIterator(), s = u.getNext();
        return Xo(t).Z({
            index: "documentKeyIndex",
            range: o
        }, (function(t, e, i) {
            // Go through keys not found in cache.
            for (var o = mt.fromSegments(r(r([], e.prefixPath), [ e.collectionGroup, e.documentId ])); s && $o(s, o) < 0; ) n(s, null), 
            s = u.getNext();
            s && s.isEqual(o) && (
            // Key found in cache.
        ...
        var r = this, i = [ e.popLast().toArray(), e.lastSegment(), Ki(n.readTime), n.documentKey.path.isEmpty() ? "" : n.documentKey.path.lastSegment() ], o = [ e.popLast().toArray(), e.lastSegment(), [ Number.MAX_SAFE_INTEGER, Number.MAX_SAFE_INTEGER ], "" ];
        return Xo(t).W(IDBKeyRange.bound(i, o, !0)).next((function(t) {
            for (var e = lr(), n = 0, i = t; n < i.length; n++) {
                var o = i[n], u = r.jn(mt.fromSegments(o.prefixPath.concat(o.collectionGroup, o.documentId)), o);
                e = e.insert(u.key, u);
            }
            return e;
        }));
    }, t.prototype.getAllFromCollectionGroup = function(t, e, n, r) {
        var i = this, o = lr(), u = Jo(e, n), s = Jo(e, _t.max());
        return Xo(t).Z({
            index: "collectionGroupIndex",
            range: IDBKeyRange.bound(u, s, !0)
        }, (function(t, e, n) {
            var u = i.jn(mt.fromSegments(e.prefixPath.concat(e.collectionGroup, e.documentId)), e);
    ...
    t.prototype.jn = function(t, e) {
        if (e) {
            ...
            /** Decodes a remote document from storage locally to a Document. */ function(t, e) {
                var n;
                if (e.document) n = Wr(t.re, e.document, !!e.hasCommittedMutations); else if (e.noDocument) {
                    var r = mt.fromSegments(e.noDocument.path), i = Qi(e.noDocument.readTime);
                    n = Fe.newNoDocument(r, i), e.hasCommittedMutations && n.setHasCommittedMutations();
                } else {
                    if (!e.unknownDocument) return j();
                    var o = mt.fromSegments(e.unknownDocument.path), u = Qi(e.unknownDocument.version);
                    n = Fe.newUnknownDocument(o, u);
                }
        ...
        return Fe.newInvalidDocument(t);
    }, t;
}();
 ...
 */ var Ho = /** @class */ function(e) {
    ...
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).Yn = t, r.trackRemovals = n, 
        // A map of document sizes and read times prior to applying the changes in
        // this buffer.
        r.Xn = new ar((function(t) {
            return t.toString();
        }), (function(t, e) {
            return t.isEqual(e);
        })), r;
    ...
    return t(n, e), n.prototype.applyChanges = function(t) {
        var e = this, n = [], r = 0, i = new Zt((function(t, e) {
            return at(t.canonicalString(), e.canonicalString());
        }));
        return this.changes.forEach((function(o, u) {
            ...
            if (n.push(e.Yn.removeEntry(t, o, s.readTime)), u.isValidDocument()) {
                ...
                var l = Gi(e.Yn.It, u.convertToNoDocument(ft.min()));
                n.push(e.Yn.addEntry(t, o, l));
            }
        })), i.forEach((function(r) {
            n.push(e.Yn.indexManager.addToCollectionParentIndex(t, r));
        })), n.push(this.Yn.updateMetadata(t, r)), Ot.waitFor(n);
        ...
        // a delta later.
                return this.Yn.Hn(t, e).next((function(t) {
            var e = t.documents;
            // Note: `getAllFromCache` returns two maps instead of a single map from
            // keys to `DocumentSizeEntry`s. This is to allow returning the
            // `MutableDocumentMap` directly, without a conversion.
            return t.Jn.forEach((function(t, r) {
                n.Xn.set(t, {
                    size: r,
    ...
    t.prototype.computeViews = function(t, e, n, r) {
        ...
        return e.forEach((function(t, e) {
            ...
            // change (hence overlay is undefined), but would now match.
                        r.has(e.key) && (void 0 === u || u.mutation instanceof Zn) ? i = i.insert(e.key, e) : void 0 !== u && (o.set(e.key, u.mutation.getFieldMask()), 
 ...
 */
    ...
    t.prototype.getNextDocuments = function(t, e, n, r) {
        ...
        // Query the remote documents and overlay mutations.
            ...
            t.forEach((function(t, e) {
                var n = e.getKey();
                null === r.get(n) && (r = r.insert(n, Fe.newInvalidDocument(n)));
            }));
    ...
    /** Returns a base document that can be used to apply `overlay`. */ t.prototype.getBaseDocument = function(t, e, n) {
        return null === n || 1 /* Patch */ === n.mutation.type ? this.remoteDocumentCache.getEntry(t, e) : Ot.resolve(Fe.newInvalidDocument(e));
    }, t;
}(), nu = /** @class */ function() {
    function t(t) {
    ...
    return t.prototype.getBundleMetadata = function(t, e) {
        return Ot.resolve(this.Zn.get(e));
    }, t.prototype.saveBundleMetadata = function(t, e) {
    ...
    function t() {
        ...
        this.overlays = new Ht(mt.comparator), this.es = new Map;
    }
    return t.prototype.getOverlay = function(t, e) {
        ...
        var o = this.es.get(e);
        void 0 === o && (o = wr(), this.es.set(e, o)), this.es.set(e, o.add(n.key));
    }, t;
}(), iu = /** @class */ function() {
    function t() {
        // A set of outstanding references to a document sorted by key.
        this.ns = new Zt(ou.ss), 
        // A set of outstanding references to a document sorted by target id.
        this.rs = new Zt(ou.os)
    ...
    /** Add references to the given document keys for the given ID. */ t.prototype.us = function(t, e) {
        var n = this;
    ...
    t.prototype.ls = function(t) {
        ...
        return this.rs.forEachInRange([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.containsKey = function(t) {
        var e = new ou(t, 0), n = this.ns.firstAfterOrEqual(e);
    ...
    return t.ss = function(t, e) {
        return mt.comparator(t.key, e.key) || at(t._s, e._s);
    }, 
    /** Compare by ID then by key */ t.os = function(t, e) {
        return at(t._s, e._s) || mt.comparator(t.key, e.key);
    }, t;
}(), uu = /** @class */ function() {
    function t(t, e) {
    ...
    return t.prototype.checkEmpty = function(t) {
        ...
        var o = new Pi(i, e, n, r);
        this.mutationQueue.push(o);
        // Track references by document key and index collection parents.
        for (var u = 0, s = r; u < s.length; u++) {
            var a = s[u];
            this.gs = this.gs.add(new ou(a.key, i)), this.indexManager.addToCollectionParentIndex(t, a.key.path.popLast());
        }
        return Ot.resolve(o);
    }, t.prototype.lookupMutationBatch = function(t, e) {
        return Ot.resolve(this.ys(e));
    }, t.prototype.getNextMutationBatchAfterBatchId = function(t, e) {
        ...
        return Ot.resolve(0 === this.mutationQueue.length ? -1 : this.ws - 1);
    }, t.prototype.getAllMutationBatches = function(t) {
        ...
        var o = new ou(new mt(i), 0), u = new Zt(at);
        ...
        var n = this;
        Q(0 === this.Ts(e.batchId, "removed")), this.mutationQueue.shift();
        var r = this.gs;
        ...
        var n = new ou(e, 0), r = this.gs.firstAfterOrEqual(n);
    ...
    t.prototype.addEntry = function(t, e) {
        var n = e.key, r = this.docs.get(n), i = r ? r.size : 0, o = this.Es(e);
    ...
    t.prototype.removeEntry = function(t) {
        ...
        return Ot.resolve(n ? n.document.mutableCopy() : Fe.newInvalidDocument(e));
    }, t.prototype.getEntries = function(t, e) {
        var n = this, r = lr();
        return e.forEach((function(t) {
            var e = n.docs.get(t);
            r = r.insert(t, e ? e.document.mutableCopy() : Fe.newInvalidDocument(t));
        })), Ot.resolve(r);
    }, t.prototype.getAllFromCollection = function(t, e, n) {
    ...
    function n(t) {
        var n = this;
        return (n = e.call(this) || this).Yn = t, n;
    }
    return t(n, e), n.prototype.applyChanges = function(t) {
        var e = this, n = [];
...
}(Qo), cu = /** @class */ function() {
    function t(t) {
        this.persistence = t, 
        /**
             * Maps a target to the data about that target
             */
        this.Rs = new ar((function(t) {
            return Be(t);
        }), Ge), 
        ...
        /**
             ...
             * IDs.
             */
        this.Ps = new iu, this.targetCount = 0, this.vs = Lo.Pn();
    }
    return t.prototype.forEachTarget = function(t, e) {
        ...
        return Ot.resolve(this.bs);
    }, t.prototype.allocateTargetId = function(t) {
        return this.highestTargetId = this.vs.next(), Ot.resolve(this.highestTargetId);
    }, t.prototype.setTargetsMetadata = function(t, e, n) {
        ...
        var e = t.targetId;
        e > this.highestTargetId && (this.vs = new Lo(e), this.highestTargetId = e), t.sequenceNumber > this.bs && (this.bs = t.sequenceNumber);
    }, t.prototype.addTargetData = function(t, e) {
        return this.Dn(e), this.targetCount += 1, Ot.resolve();
    }, t.prototype.updateTargetData = function(t, e) {
        return this.Dn(e), Ot.resolve();
    }, t.prototype.removeTargetData = function(t, e) {
        ...
        return this.Ps.us(e, n), Ot.resolve();
    }, t.prototype.removeMatchingKeys = function(t, e, n) {
        this.Ps.hs(e, n);
        ...
        return this.Ps.ls(e), Ot.resolve();
    }, t.prototype.getMatchingKeysForTargetId = function(t, e) {
        var n = this.Ps.ds(e);
        return Ot.resolve(n);
    }, t.prototype.containsKey = function(t, e) {
        return Ot.resolve(this.Ps.containsKey(e));
    }, t;
}(), lu = /** @class */ function() {
    /**
    ...
    function t(t, e) {
        var n = this;
        this.Vs = {}, this.overlays = {}, this.Ss = new jt(0), this.Ds = !1, this.Ds = !0, 
        this.referenceDelegate = t(this), this.Cs = new cu(this), this.indexManager = new yo, 
        this.remoteDocumentCache = new su((function(t) {
            return n.referenceDelegate.xs(t);
        })), this.It = new Bi(e), this.Ns = new nu(this.It);
    }
    return t.prototype.start = function() {
        ...
        return n || (n = new uu(e, this.referenceDelegate), this.Vs[t.toKey()] = n), n;
        ...
        var i = new hu(this.Ss.next());
        return this.referenceDelegate.ks(), n(i).next((function(t) {
            return r.referenceDelegate.Ms(i).next((function() {
                return t;
            }));
        ...
        return Ot.or(Object.values(this.Vs).map((function(n) {
            return function() {
    ...
    return t.Bs = function(e) {
        return new t(e);
    }, Object.defineProperty(t.prototype, "Ls", {
        get: function() {
        ...
        return this.Fs.addReference(n, e), this.Ls.delete(n.toString()), Ot.resolve();
    }, t.prototype.removeReference = function(t, e, n) {
        return this.Fs.removeReference(n, e), this.Ls.add(n.toString()), Ot.resolve();
    }, t.prototype.markPotentiallyOrphaned = function(t, e) {
        return this.Ls.add(e.toString()), Ot.resolve();
    }, t.prototype.removeTarget = function(t, e) {
        var n = this;
        this.Fs.ls(e.targetId).forEach((function(t) {
            return n.Ls.add(t.toString());
        }));
        ...
        // Remove newly orphaned documents.
                return Ot.forEach(this.Ls, (function(r) {
            var i = mt.fromPath(r);
            return e.Us(t, i).next((function(t) {
                t || n.removeEntry(i, ft.min());
            }));
        })).next((function() {
            return e.$s = null, n.apply(t);
        }));
    }, t.prototype.updateLimboDocument = function(t, e) {
        var n = this;
        return this.Us(t, e).next((function(t) {
            t ? n.Ls.delete(e.toString()) : n.Ls.add(e.toString());
        }));
        ...
        return Ot.or([ function() {
            return Ot.resolve(n.Fs.containsKey(e));
        }, function() {
            return n.persistence.getTargetCache().containsKey(t, e);
        }, function() {
            return n.persistence.Os(t, e);
        } ]);
    }, t;
}(), du = /** @class */ function() {
    function t(t) {
    ...
    t.prototype.Gs = function(t) {
        ...
        var n = this, r = e.store("mutations"), i = Wo(this.It), o = new lu(fu.Bs, this.It.re);
        return r.W().next((function(t) {
            var r = new Map;
            return t.forEach((function(t) {
                var e, i = null !== (e = r.get(t.userId)) && void 0 !== e ? e : wr();
                zi(n.It, t).keys().forEach((function(t) {
                    return i = i.add(t);
                })), r.set(t.userId, i);
            })), Ot.forEach(r, (function(t, r) {
                var u = new R(r), s = no.oe(n.It, u), a = o.getIndexManager(u), c = Ao.oe(u, n.It, a, o.referenceDelegate);
                return new eu(i, c, s, a).recalculateAndSaveOverlaysForDocumentKeys(new Ri(e, jt.at), t).next();
            }));
        }));
    }, t;
}();
...
var vu = "Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.", yu = /** @class */ function() {
    ...
    l, h) {
        ...
        this.clientId = r, this.Hs = o, this.window = u, this.document = s, this.Js = c, 
        this.Ys = l, this.Xs = h, this.Ss = null, this.Ds = !1, this.isPrimary = !1, this.networkEnabled = !0, 
        ...
        this.si = function(t) {
            return Promise.resolve();
        }, !t.C()) throw new Y(H.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
        this.referenceDelegate = new Ko(this, i), this.ii = n + "main", this.It = new Bi(a), 
        this.ri = new Lt(this.ii, this.Xs, new du(this.It)), this.Cs = new Ro(this.referenceDelegate, this.It), 
        this.remoteDocumentCache = Wo(this.It), this.Ns = new $i, this.window && this.window.localStorage ? this.oi = this.window.localStorage : (this.oi = null, 
     ...
     */    return t.prototype.start = function() {
        ...
        // do.
            ...
            return t.ci(), t.ai(), t.hi(), t.runTransaction("getHighestListenSequenceNumber", "readonly", (function(e) {
                return t.Cs.getHighestSequenceNumber(e);
            }));
        })).then((function(e) {
            t.Ss = new jt(e, t.Js);
        })).then((function() {
    ...
    t.prototype.setNetworkEnabled = function(t) {
        ...
        this.Hs.enqueueAndForget((function() {
            return e(r, void 0, void 0, (function() {
                return n(this, (function(t) {
                    switch (t.label) {
                      case 0:
                        return this.started ? [ 4 /*yield*/ , this.ui() ] : [ 3 /*break*/ , 2 ];
    ...
    t.prototype.ui = function() {
        ...
        return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (function(e) {
            return gu(e).put({
                ...
                if (t.isPrimary) return t.fi(e).next((function(e) {
                    e || (t.isPrimary = !1, t.Hs.enqueueRetryable((function() {
                        return t.si(!1);
                    })));
                }));
            })).next((function() {
                ...
                return t.isPrimary && !n ? t._i(e).next((function() {
                    return !1;
            ...
            t.isPrimary !== e && t.Hs.enqueueRetryable((function() {
                return t.si(e);
            })), t.isPrimary = e;
        }));
    ...
    t.prototype.yi = function() {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return !this.isPrimary || this.pi(this.ni, 18e5) ? [ 3 /*break*/ , 2 ] : (this.ni = Date.now(), 
                    [ 4 /*yield*/ , this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", (function(t) {
                        ...
                        return e.W().next((function(t) {
                            var n = o.Ii(t, 18e5), r = t.filter((function(t) {
                  ...
                  case 1:
                    ...
                    if (t = n.sent(), this.oi) for (e = 0, r = t; e < r.length; e++) i = r[e], this.oi.removeItem(this.Ti(i.clientId));
                    n.label = 2;
    ...
    t.prototype.hi = function() {
        var t = this;
        this.ei = this.Hs.enqueueAfterDelay("client_metadata_refresh" /* ClientMetadataRefresh */ , 4e3, (function() {
            return t.ui().then((function() {
                return t.yi();
            })).then((function() {
                return t.hi();
            }));
    ...
    /** Checks whether `client` is the local client. */ t.prototype.mi = function(t) {
    ...
    t.prototype.di = function(t) {
        var e = this;
        return this.Ys ? Ot.resolve(!0) : mu(t).get("owner").next((function(n) {
            ...
            if (null !== n && e.pi(n.leaseTimestampMs, 5e3) && !e.Ei(n.ownerId)) {
                if (e.mi(n) && e.networkEnabled) return !0;
                if (!e.mi(n)) {
            ...
            return !(!e.networkEnabled || !e.inForeground) || gu(t).W().next((function(t) {
                return void 0 === e.Ii(t, 5e3).find((function(t) {
            ...
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    return this.Ds = !1, this.Ai(), this.ei && (this.ei.cancel(), this.ei = null), this.Ri(), 
                    this.bi(), [ 4 /*yield*/ , this.ri.runTransaction("shutdown", "readwrite", [ "owner", "clientMetadata" ], (function(e) {
                        var n = new Ri(e, jt.at);
                        return t._i(n).next((function() {
                            return t.gi(n);
                        }));
                    })) ];
    ...
    t.prototype.Ii = function(t, e) {
        ...
        return t.filter((function(t) {
            return n.pi(t.updateTimeMs, e) && !n.Ei(t.clientId);
        }));
    }, 
    /**
    ...
    t.prototype.vi = function() {
        ...
        return this.runTransaction("getActiveClients", "readonly", (function(e) {
            return gu(e).W().next((function(e) {
                return t.Ii(e, 18e5).map((function(t) {
                    return t.clientId;
                }));
            }));
        }));
        ...
        return Ao.oe(t, this.It, e, this.referenceDelegate);
    }, t.prototype.getTargetCache = function() {
        return this.Cs;
    }, t.prototype.getRemoteDocumentCache = function() {
        return this.remoteDocumentCache;
    }, t.prototype.getIndexManager = function(t) {
        return new wo(t, this.It.re.databaseId);
    }, t.prototype.getDocumentOverlayCache = function(t) {
        return no.oe(this.It, t);
    }, t.prototype.getBundleCache = function() {
        return this.Ns;
    }, t.prototype.runTransaction = function(t, e, n) {
        var r = this;
        U("IndexedDbPersistence", "Starting transaction:", t);
        var i, o, u = "readonly" === e ? "readonly" : "readwrite", s = 15 === (i = this.Xs) ? Li : 14 === i ? Vi : 13 === i ? Oi : 12 === i ? ki : 11 === i ? Ci : void j();
        /** Returns the object stores for the provided schema. */        
        // Do all transactions as readwrite against all object stores, since we
        // are the only reader/writer.
        return this.ri.runTransaction(t, u, s, (function(i) {
            return o = new Ri(i, r.Ss ? r.Ss.next() : jt.at), "readwrite-primary" === e ? r.fi(o).next((function(t) {
                return !!t || r.di(o);
            })).next((function(e) {
                if (!e) throw B("Failed to obtain primary lease for action '" + t + "'."), r.isPrimary = !1, 
                r.Hs.enqueueRetryable((function() {
                    return r.si(!1);
                })), new Y(H.FAILED_PRECONDITION, At);
                return n(o);
            })).next((function(t) {
                return r.wi(o).next((function() {
                    return t;
                }));
            })) : r.Vi(o).next((function() {
                return n(o);
            }));
        })).then((function(t) {
    ...
    t.prototype.Vi = function(t) {
        var e = this;
        return mu(t).get("owner").next((function(t) {
            if (null !== t && e.pi(t.leaseTimestampMs, 5e3) && !e.Ei(t.ownerId) && !e.mi(t) && !(e.Ys || e.allowTabSynchronization && t.allowTabSynchronization)) throw new Y(H.FAILED_PRECONDITION, vu);
        }));
    }, 
    /**
    ...
    /** Checks the primary lease and removes it if we are the current primary. */ t.prototype._i = function(t) {
        ...
        return n.get("owner").next((function(t) {
            return e.mi(t) ? (U("IndexedDbPersistence", "Releasing primary lease."), n.delete("owner")) : Ot.resolve();
        }));
    }, 
    /** Verifies that `updateTimeMs` is within `maxAgeMs`. */ t.prototype.pi = function(t, e) {
        ...
        null !== this.document && "function" == typeof this.document.addEventListener && (this.ti = function() {
            t.Hs.enqueueAndForget((function() {
                return t.inForeground = "visible" === t.document.visibilityState, t.ui();
            }));
    ...
    t.prototype.ai = function() {
        ...
        "function" == typeof (null === (t = this.window) || void 0 === t ? void 0 : t.addEventListener) && (this.Zs = function() {
            ...
            e.Ai(), p() && navigator.appVersion.match(/Version\/1[45]/) && 
            // On Safari 14 and 15, we do not run any cleanup actions as it might
            // trigger a bug that prevents Safari from re-opening IndexedDB during
            // the next page load.
            // See https://bugs.webkit.org/show_bug.cgi?id=226547
            e.Hs.enterRestrictedMode(/* purgeExistingTasks= */ !0), e.Hs.enqueueAndForget((function() {
                return e.shutdown();
            }));
    ...
    /** Removes the zombied client entry if it exists. */ t.prototype.Pi = function() {
        if (this.oi) try {
...
var bu = /** @class */ function() {
    function t(t, e, n, r) {
        this.targetId = t, this.fromCache = e, this.Si = n, this.Di = r;
    }
    ...
    t.prototype.ki = function(t, e) {
        ...
        return this.indexManager.getIndexType(t, r).next((function(i) {
            ...
            e = mn(e, null, "F" /* First */), r = yn(e)), n.indexManager.getDocumentsMatchingTarget(t, r).next((function(i) {
                ...
                return n.Ni.getDocuments(t, o).next((function(i) {
                    return n.indexManager.getMinOffset(t, r).next((function(r) {
                        var u = n.Fi(e, i);
                        return n.$i(e, u, o, r.readTime) ? n.ki(t, mn(e, null, "F" /* First */)) : n.Bi(t, u, e, r);
                    }));
                }));
            })));
        }));
    ...
    t.prototype.Mi = function(t, e, n, r) {
        var i = this;
        return hn(e) || r.isEqual(ft.min()) ? this.Oi(t, e) : this.Ni.getDocuments(t, n).next((function(o) {
            var u = i.Fi(e, o);
            return i.$i(e, u, n, r) ? i.Oi(t, e) : (F() <= h.DEBUG && U("QueryEngine", "Re-using previous result from %s to execute query: %s", r.toString(), bn(e)), 
            i.Bi(t, u, e, Dt(r, -1)));
        }));
    ...
    t.prototype.$i = function(t, e, n, r) {
        ...
        return F() <= h.DEBUG && U("QueryEngine", "Using full collection scan to execute query:", bn(e)), 
        this.Ni.getDocumentsMatchingQuery(t, e, _t.min());
    }, 
    /**
     * Combines the results from an indexed execution with the remaining documents
     * that have not yet been indexed.
     */
    t.prototype.Bi = function(t, e, n, r) {
        // Retrieve all results for documents that were updated since the offset.
        return this.Ni.getDocumentsMatchingQuery(t, n, r).next((function(t) {
    ...
    t, e, n, r) {
        this.persistence = t, this.Li = e, this.It = r, 
        /**
    ...
    return t.prototype.Qi = function(t) {
        ...
        this.mutationQueue = this.persistence.getMutationQueue(t, this.indexManager), this.localDocuments = new eu(this.Gi, this.mutationQueue, this.documentOverlayCache, this.indexManager), 
 ...
 */ function Du(t, e) {
    ...
    return n.persistence.runTransaction("Acknowledge batch", "readwrite-primary", (function(t) {
        var r = e.batch.keys(), i = n.Gi.newChangeBuffer({
            trackRemovals: !0
        });
        return function(t, e, n, r) {
            ...
            return o.forEach((function(t) {
                u = u.next((function() {
                    ...
                    Q(null !== o), e.version.compareTo(o) < 0 && (i.applyToRemoteDocument(e, n), e.isValidDocument() && (
 ...
 */ function _u(t, e) {
    ...
    return n.persistence.runTransaction("Apply remote event", "readwrite-primary", (function(t) {
        ...
        e.targetChanges.forEach((function(o, s) {
            ...
            if (a) {
                ...
                u.push(n.Cs.removeMatchingKeys(t, o.removedDocuments, s).next((function() {
                    return n.Cs.addMatchingKeys(t, o.addedDocuments, s);
                })));
     ...
     */
                ...
                }(a, c, o) && u.push(n.Cs.updateTargetData(t, c));
            }
        }));
        var s = lr(), a = wr();
        ...
        u.push(Nu(t, o, e.documentUpdates).next((function(t) {
            ...
            var c = n.Cs.getLastRemoteSnapshotVersion(t).next((function(e) {
                return n.Cs.setTargetsMetadata(t, t.currentSequenceNumber, r);
            }));
            u.push(c);
        }
 ...
 */ function Cu(t, e) {
    ...
    return n.persistence.runTransaction("Allocate target", "readwrite", (function(t) {
        ...
        return n.Cs.getTargetData(t, e).next((function(i) {
            ...
            r = i, Ot.resolve(r)) : n.Cs.allocateTargetId(t).next((function(i) {
                return r = new Ui(e, i, 0 /* Listen */ , t.currentSequenceNumber), n.Cs.addTargetData(t, r).next((function() {
                    return r;
                }));
            }));
        }));
...
function ku(t, r, i) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                e = W(t), o = e.Ui.get(r), u = i ? "readwrite" : "readwrite-primary", n.label = 1;
              ...
              case 5:
                return e.Ui = e.Ui.remove(r), e.qi.delete(o.target), [ 2 /*return*/ ];
            }
        }));
    }));
}
 ...
 */ function Ou(t, e, n) {
    ...
    return r.persistence.runTransaction("Execute query", "readonly", (function(t) {
        return function(t, e, n) {
            var r = W(t), i = r.qi.get(n);
            return void 0 !== i ? Ot.resolve(r.Ui.get(i)) : r.Cs.getTargetData(e, n);
            ...
            return r.Li.getDocumentsMatchingQuery(t, e, n ? i : ft.min(), n ? o : wr());
        })).next((function(t) {
            return Ru(r, En(e), t), {
                documents: t,
                Hi: o
...
// PORTING NOTE: Multi-Tab only.
function Vu(t, e) {
    var n = W(t), r = W(n.Cs), i = n.Ui.get(e);
 ...
 */ function Mu(t, r, i, o) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                for (e = W(t), u = wr(), s = lr(), a = 0, c = i; a < c.length; a++) l = c[a], h = r.Ji(l.metadata.name), 
                l.document && (u = u.add(h)), (f = r.Yi(l)).setReadTime(r.Xi(l.metadata.readTime)), 
                s = s.insert(h, f);
                return d = e.Gi.newChangeBuffer({
                    trackRemovals: !0
                }), [ 4 /*yield*/ , Cu(e, function(t) {
                ...
                return p = n.sent(), [ 2 /*return*/ , e.persistence.runTransaction("Apply bundle documents", "readwrite", (function(t) {
                    return Nu(t, d, s).next((function(e) {
                        ...
                        return e.Cs.removeMatchingKeysForTargetId(t, p.targetId).next((function() {
                            return e.Cs.addMatchingKeys(t, u, p.targetId);
                        })).next((function() {
                            return e.localDocuments.getLocalViewOfDocuments(t, n.Wi, n.zi);
                        })).next((function() {
                            return n.Wi;
                        }));
                    }));
 ...
 */ function Pu(t, r, i) {
    return void 0 === i && (i = wr()), e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return [ 4 /*yield*/ , Cu(t, yn(Yi(r.bundledQuery))) ];
              ...
              case 1:
                return e = n.sent(), [ 2 /*return*/ , (o = W(t)).persistence.runTransaction("Save named query", "readwrite", (function(t) {
                    ...
                    // has.
                                        if (e.snapshotVersion.compareTo(n) >= 0) return o.Ns.saveNamedQuery(t, r);
                    // Update existing target data because the query from the bundle is newer.
                                        var u = e.withResumeToken(ne.EMPTY_BYTE_STRING, n);
                    return o.Ui = o.Ui.insert(u.targetId, u), o.Cs.updateTargetData(t, u).next((function() {
                        return o.Cs.removeMatchingKeysForTargetId(t, e.targetId);
                    })).next((function() {
                        return o.Cs.addMatchingKeys(t, i, e.targetId);
                    })).next((function() {
                        return o.Ns.saveNamedQuery(t, r);
                    }));
                })) ];
            }
        }));
...
/** Assembles the key for a client state in WebStorage */ function Fu(t, e) {
...
var Bu = /** @class */ function() {
    ...
    function t(t, e, n, r, i) {
        this.window = t, this.Hs = e, this.persistenceKey = n, this.sr = r, this.syncEngine = null, 
        this.onlineStateHandler = null, this.sequenceNumberHandler = null, this.ir = this.rr.bind(this), 
        this.ur = new Ht(at), this.started = !1, 
        /**
        ...
        var o = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.window.localStorage, this.currentUser = i, this.ar = Fu(this.persistenceKey, this.sr), 
        this.hr = 
        /** Assembles the key for the current sequence number. */
        function(t) {
            return "firestore_sequence_number_" + t;
        }(this.persistenceKey), this.ur = this.ur.insert(this.sr, new Qu), this.lr = new RegExp("^firestore_clients_" + o + "_([^_]*)$"), 
        this.dr = new RegExp("^firestore_mutations_" + o + "_(\\d+)(?:_(.*))?$"), this._r = new RegExp("^firestore_targets_" + o + "_(\\d+)$"), 
        this.wr = 
    ...
    /** Returns 'true' if WebStorage is available in the current environment. */    return t.C = function(t) {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    for (t = n.sent(), e = 0, r = t; e < r.length; e++) (i = r[e]) !== this.sr && (o = this.getItem(Fu(this.persistenceKey, i))) && (u = Ku.Zi(i, o)) && (this.ur = this.ur.insert(u.clientId, u));
        ...
        var e = !1;
        return this.ur.forEach((function(n, r) {
        ...
        // `Window.addEventListener`.
            ...
            if (U("SharedClientState", "EVENT", i.key, i.newValue), i.key === this.ar) return void B("Received WebStorage notification for local change. Another client might have garbage-collected our state");
            this.Hs.enqueueRetryable((function() {
                return e(r, void 0, void 0, (function() {
                    var t, e, r, o, u, s, a, c = this;
                    return n(this, (function(n) {
                        switch (n.label) {
                          case 0:
                            return this.started ? null === i.key ? [ 3 /*break*/ , 7 ] : this.lr.test(i.key) ? null == i.newValue ? (t = this.vr(i.key), 
                            [ 2 /*return*/ , this.Vr(t, null) ]) : (e = this.Sr(i.key, i.newValue)) ? [ 2 /*return*/ , this.Vr(e.clientId, e) ] : [ 3 /*break*/ , 7 ] : [ 3 /*break*/ , 1 ] : [ 3 /*break*/ , 8 ];

                          case 1:
                            return this.dr.test(i.key) ? null !== i.newValue && (r = this.Dr(i.key, i.newValue)) ? [ 2 /*return*/ , this.Cr(r) ] : [ 3 /*break*/ , 7 ] : [ 3 /*break*/ , 2 ];

                          case 2:
                            return this._r.test(i.key) ? null !== i.newValue && (o = this.Nr(i.key, i.newValue)) ? [ 2 /*return*/ , this.kr(o) ] : [ 3 /*break*/ , 7 ] : [ 3 /*break*/ , 3 ];

                          case 3:
                            return i.key !== this.wr ? [ 3 /*break*/ , 4 ] : null !== i.newValue && (u = this.yr(i.newValue)) ? [ 2 /*return*/ , this.pr(u) ] : [ 3 /*break*/ , 7 ];

                          case 4:
                            return i.key !== this.hr ? [ 3 /*break*/ , 5 ] : (s = function(t) {
                                var e = jt.at;
                                if (null != t) try {
                                    var n = JSON.parse(t);
                                ...
                                return e;
                            }(i.newValue), s !== jt.at && this.sequenceNumberHandler(s), [ 3 /*break*/ , 7 ]);

                          case 5:
                            return i.key !== this.mr ? [ 3 /*break*/ , 7 ] : (a = this.Mr(i.newValue), [ 4 /*yield*/ , Promise.all(a.map((function(t) {
                                return c.syncEngine.Or(t);
                            }))) ]);
    ...
    }, Object.defineProperty(t.prototype, "Ar", {
        get: function() {
        ...
        var r = Uu(this.persistenceKey, t), i = new Gu(t, e, n);
        this.setItem(r, i.tr());
    ...
    t.prototype.Nr = function(t, e) {
        var n = this._r.exec(t), r = Number(n[1]);
        return Gu.Zi(r, e);
    }, 
    /**
    ...
    t.prototype.yr = function(t) {
        ...
        return e(this, void 0, void 0, (function() {
            return n(this, (function(e) {
                return t.user.uid === this.currentUser.uid ? [ 2 /*return*/ , this.syncEngine.Fr(t.batchId, t.state, t.error) ] : (U("SharedClientState", "Ignoring mutation for non-active user " + t.user.uid), 
                [ 2 /*return*/ ]);
            }));
        }));
        ...
        var n = this, r = e ? this.ur.insert(t, e) : this.ur.remove(t), i = this.Ir(this.ur), o = this.Ir(r), u = [], s = [];
        return o.forEach((function(t) {
            i.has(t) || u.push(t);
        })), i.forEach((function(t) {
            o.has(t) || s.push(t);
        })), this.syncEngine.Br(u, s).then((function() {
            n.ur = r;
        }));
    }, t.prototype.pr = function(t) {
    ...
    function t() {
        this.Lr = new Qu, this.Ur = {}, this.onlineStateHandler = null, this.sequenceNumberHandler = null;
    }
    return t.prototype.addPendingMutation = function(t) {
        ...
        return this.Lr = new Qu, Promise.resolve();
    }, t.prototype.handleUserChange = function(t, e, n) {
        // No op.
    }, t.prototype.setOnlineState = function(t) {
        // No op.
    ...
    return t.prototype.qr = function(t) {
        ...
        for (var t = 0, e = this.Wr; t < e.length; t++) {
            (0, e[t])(0 /* AVAILABLE */);
        }
     ...
     * HTTP).
     */
    return t(n, e), n.prototype.lo = function(t, e, n, r) {
        ...
        var r = [ this.oo, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], i = N(), o = A(), u = {
        ...
        this.useFetchStreams && (u.xmlHttpFactory = new C({})), this.ho(u.initMessageHeaders, e, n), 
        ...
        var a = i.createWebChannel(s, u), c = !1, l = !1, h = new Zu({
            Hr: function(t) {
        ...
        return f(a, k.EventType.OPEN, (function() {
            ...
            l || (l = !0, U("Connection", "WebChannel transport closed"), h.io());
        })), f(a, k.EventType.ERROR, (function(t) {
            l || (l = !0, G("Connection", "WebChannel transport errored:", t), h.io(new Y(H.UNAVAILABLE, "The operation could not be completed")));
 ...
 */
                    ...
                    l = !0, h.io(new Y(u, s)), a.close();
                } else U("Connection", "WebChannel received:", n), h.ro(n);
            }
    ...
    return t.prototype.co = function(t, e, n, r, i) {
        ...
        var u = {};
        return this.ho(u, r, i), this.lo(t, o, u, n).then((function(t) {
            return U("RestConnection", "Received: ", t), t;
        }), (function(e) {
            throw G("RestConnection", t + " failed with error: ", e, "url: ", o, "request:", n), 
            e;
        }));
 ...
 */ var ns = /** @class */ function() {
     ...
     */ , i) {
        ...
        this.Hs = t, this.timerId = e, this.wo = n, this.mo = r, this.yo = i, this.po = 0, 
        this.Io = null, 
    ...
    t.prototype.Ao = function(t) {
        ...
        // honored as such).
        var n = Math.floor(this.po + this.Ro()), r = Math.max(0, Date.now() - this.To), i = Math.max(0, n - r);
        // Guard against lastAttemptTime being in the future due to a clock change.
                i > 0 && U("ExponentialBackoff", "Backing off for " + i + " ms (base delay: " + this.po + " ms, delay with jitter: " + n + " ms, last attempt: " + r + " ms ago)"), 
        this.Io = this.Hs.enqueueAfterDelay(this.timerId, i, (function() {
            return e.To = Date.now(), t();
        })), 
    ...
    /** Returns a random value in the range [-currentBaseMs/2, currentBaseMs/2] */ t.prototype.Ro = function() {
        return (Math.random() - .5) * this.po;
    }, t;
}(), rs = /** @class */ function() {
    function t(t, e, n, r, i, o, u, s) {
        this.Hs = t, this.Po = n, this.vo = r, this.Vo = i, this.authCredentialsProvider = o, 
        ...
        /**
             ...
             * close.
             */
        this.So = 0, this.Do = null, this.Co = null, this.stream = null, this.xo = new ns(t, e)
        /**
    ...
    t.prototype.Fo = function() {
        ...
        // running a timer (in which case the previous idle timeout still applies).
                this.ko() && null === this.Do && (this.Do = this.Hs.enqueueAfterDelay(this.Po, 6e4, (function() {
            return t.$o();
        })));
    }, 
            ...
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    this.xo.reset() : r && r.code === H.RESOURCE_EXHAUSTED ? (
                    // Log the error. (Probably either 'quota exceeded' or 'max queue length reached'.)
                    B(r.toString()), B("Using maximum backoff delay to prevent overloading the backend."), 
                    this.xo.Eo()) : r && r.code === H.UNAUTHENTICATED && 3 /* Healthy */ !== this.state && (
    ...
    t.prototype.qo = function() {}, t.prototype.auth = function() {
        ...
        var t = this;
        this.state = 5 /* Backoff */ , this.xo.Ao((function() {
    ...
    t.prototype.Ko = function(t) {
        ...
        return function(n) {
            e.Hs.enqueueAndForget((function() {
                return e.So === t ? n() : (U("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve());
            }));
        };
    }, t;
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var r = function(t) {
                    ...
                    return t.gt ? (Q(void 0 === e || "string" == typeof e), ne.fromBase64String(e || "")) : (Q(void 0 === e || e instanceof Uint8Array), 
                ...
                var c = Br(t, a.document.name), l = Pr(a.document.updateTime), h = new Me({
                    mapValue: {
                        fields: a.document.fields
                    }
                }), f = Fe.newFoundDocument(c, l, h), d = a.targetIds || [], p = a.removedTargetIds || [];
                n = new Sr(d, p, f.key, f);
            } else if ("documentDelete" in e) {
                e.documentDelete;
                var v = e.documentDelete;
                v.document;
                var y = Br(t, v.document), m = v.readTime ? Pr(v.readTime) : ft.min(), g = Fe.newNoDocument(y, m), w = v.removedTargetIds || [];
                n = new Sr([], w, g.key, g);
            ...
            return e.targetIds && e.targetIds.length ? ft.min() : e.readTime ? Pr(e.readTime) : ft.min();
        }(t);
    ...
    n.prototype.zo = function(t) {
        var e = {};
        e.database = jr(this.It), e.addTarget = function(t, e) {
            var n, r = e.target;
            return (n = Ke(r) ? {
                documents: Xr(t, r)
            } : {
            ...
            // of serialization).
            n.readTime = Lr(t, e.snapshotVersion.toTimestamp())), n;
        }(this.It, t);
        var n = function(t, e) {
            var n = function(t, e) {
                switch (e) {
    ...
    n.prototype.Ho = function(t) {
        var e = {};
        e.database = jr(this.It), e.removeTarget = t, this.Bo(e);
    }, n;
    ...
    n.prototype.start = function() {
        ...
        Q(!!t.streamToken), this.lastStreamToken = t.streamToken, this.Jo) {
            ...
            this.xo.reset();
            var e = function(t, e) {
                return t && t.length > 0 ? (Q(void 0 !== e), t.map((function(t) {
                    return function(t, e) {
                        // NOTE: Deletes don't have an updateTime.
                        var n = t.updateTime ? Pr(t.updateTime) : Pr(e);
                        ...
                        n = Pr(e)), new Bn(n, t.transformResults || []);
                    }(t, e);
                }))) : [];
            }(t.writeResults, t.commitTime), n = Pr(t.commitTime);
            return this.listener.Zo(n, e);
        }
        // The first response is always the handshake response
                return Q(!t.writeResults || 0 === t.writeResults.length), this.Jo = !0, 
        this.listener.tu();
    }, 
    /**
    ...
    n.prototype.eu = function() {
        ...
        var t = {};
        t.database = jr(this.It), this.Bo(t);
    }, 
    ...
    function n(t, n, r, i) {
        ...
        o.Vo = r, o.It = i, o.nu = !1, o;
    }
    return t(n, e), n.prototype.su = function() {
        if (this.nu) throw new Y(H.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
    ...
    t.prototype.set = function(t) {
        ...
        this.ou ? (B(e), this.ou = !1) : U("OnlineStateTracker", e);
                        ...
                        [ 4 /*yield*/ , function(t) {
                            return e(this, void 0, void 0, (function() {
                                ...
                                return n(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = W(t))._u.add(4 /* ConnectivityChange */), [ 4 /*yield*/ , ls(e) ];
 ...
 */ function fs(t, e) {
    var n = W(t), r = Vs(n);
    n.du.delete(e), r.ko() && ps(n, e), 0 === n.du.size && (r.ko() ? r.Fo() : ms(n) && 
...
function ys(t) {
    return ms(t) && !Vs(t).No() && t.du.size > 0;
}

function ms(t) {
    return 0 === W(t)._u.size;
}
...
function Is(t, r, i) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(a) {
            switch (a.label) {
              case 0:
                if (t.gu.set("Online" /* Online */), !(r instanceof xr && 2 /* Removed */ === r.state && r.cause)) 
              ...
              case 6:
                if (r instanceof Sr ? t.yu.Gt(r) : r instanceof Dr ? t.yu.Yt(r) : t.yu.Wt(r), i.isEqual(ft.min())) return [ 3 /*break*/ , 13 ];
                a.label = 7;
                ...
                function(t, e) {
                    ...
                    n.targetMismatches.forEach((function(e) {
                        ...
                        if (n) {
                            ...
                            // state.
                            t.du.set(e, n.withResumeToken(ne.EMPTY_BYTE_STRING, n.snapshotVersion)), 
        ...
        return n(this, (function(u) {
            switch (u.label) {
              case 0:
                ...
                return t._u.add(1 /* IndexedDbFailed */), [ 4 /*yield*/ , ls(t) ];
                    ...
                    return e(o, void 0, void 0, (function() {
                        return n(this, (function(e) {
                            switch (e.label) {
                              ...
                              case 1:
                                return e.sent(), t._u.delete(1 /* IndexedDbFailed */), [ 4 /*yield*/ , cs(t) ];
...
function Ss(t) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                e = W(t), r = Ls(e), i = e.fu.length > 0 ? e.fu[e.fu.length - 1].batchId : -1, n.label = 1;
...
function Ds(t) {
    return ms(t) && !Ls(t).No() && t.fu.length > 0;
}
...
function Ns(t) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            ...
            for (e = Ls(t), r = 0, i = t.fu; r < i.length; r++) o = i[r], e.Xo(o.mutations);
            return [ 2 /*return*/ ];
        }));
    }));
}
...
function As(t, r, i) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return e = t.fu.shift(), o = Fi.from(e, r, i), [ 4 /*yield*/ , Ts(t, (function() {
...
function Cs(t, r) {
    return e(this, void 0, void 0, (function() {
        return n(this, (function(i) {
            switch (i.label) {
              case 0:
                return r && Ls(t).Yo ? [ 4 /*yield*/ , function(t, r) {
                    return e(this, void 0, void 0, (function() {
                        var e, i;
                        return n(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return ur(i = r.code) && i !== H.ABORTED ? (e = t.fu.shift(), 
                                // In this case it's also unlikely that the server itself is melting
                                // down -- this was just a bad request so inhibit backoff on the next
                                // restart.
                                Ls(t).Oo(), [ 4 /*yield*/ , Ts(t, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                ...
                e._u.add(3 /* CredentialChange */), [ 4 /*yield*/ , ls(e) ];
              ...
              case 2:
                return n.sent(), e._u.delete(3 /* CredentialChange */), [ 4 /*yield*/ , cs(e) ];
 ...
 */ function Os(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return e = W(t), r ? (e._u.delete(2 /* IsSecondary */), [ 4 /*yield*/ , cs(e) ]) : [ 3 /*break*/ , 2 ];

              case 1:
                return n.sent(), [ 3 /*break*/ , 5 ];

              case 2:
                return r ? [ 3 /*break*/ , 4 ] : (e._u.add(2 /* IsSecondary */), [ 4 /*yield*/ , ls(e) ]);
 ...
 */ function Vs(t) {
    ...
    t.pu = function(t, e, n) {
        var r = W(t);
        return r.su(), new is(e, r.Vo, r.authCredentials, r.appCheckCredentials, r.It, n);
        ...
        return e(r, void 0, void 0, (function() {
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return i ? (t.pu.Oo(), ys(t) ? vs(t) : t.gu.set("Unknown" /* Unknown */), [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 1 ];
...
function Ls(t) {
    ...
    t.Iu = function(t, e, n) {
        var r = W(t);
        return r.su(), new os(e, r.Vo, r.authCredentials, r.appCheckCredentials, r.It, n);
    }(t.datastore, t.asyncQueue, {
        Yr: _s.bind(null, t),
        Zr: Cs.bind(null, t),
        tu: Ns.bind(null, t),
        ...
        return e(r, void 0, void 0, (function() {
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return i ? (t.Iu.Oo(), [ 4 /*yield*/ , Ss(t) ]) : [ 3 /*break*/ , 2 ];
                  ...
                  case 3:
                    e.sent(), t.fu.length > 0 && (U("RemoteStore", "Stopping write stream with " + t.fu.length + " pending writes"), 
                    t.fu = []), e.label = 4;
 ...
 */ function Ms(t, e) {
    if (B("AsyncQueue", e + ": " + t), Pt(t)) return new Y(H.UNAVAILABLE, e + ": " + t);
    throw t;
}
 ...
 */ var Ps = /** @class */ function() {
    ...
    this.queries = new ar((function(t) {
        return wn(t);
    }), gn), this.onlineState = "Unknown" /* Unknown */ , this.Ru = new Set;
};
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              ...
              case 3:
                return a = n.sent(), c = Ms(a, "Initialization of query '" + bn(r.query) + "' failed"), 
                [ 2 /*return*/ , void r.onError(c) ];

              case 4:
                return e.queries.set(i, u), u.listeners.push(r), 
                // Run global snapshot listeners if a consistent snapshot has been emitted.
                r.bu(e.onlineState), u.Au && r.Pu(u.Au) && zs(e), [ 2 /*return*/ ];
            }
        }));
    }));
}
 ...
 */ var Ws = /** @class */ function() {
    ...
    /** Returns whether a snapshot was raised. */ t.prototype.bu = function(t) {
        ...
        t = qs.fromInitialDocuments(t.query, t.docs, t.mutatedKeys, t.fromCache), this.Vu = !0, 
        this.vu.next(t);
    }, t;
}(), Hs = /** @class */ function() {
    function t(t, 
    ...
    t.prototype.Yi = function(t) {
        return t.metadata.exists ? Wr(this.It, t.document, !1) : Fe.newNoDocument(this.Ji(t.metadata.name), this.Xi(t.metadata.readTime));
    ...
    function t(t, e, n) {
        ...
        this.collectionGroups = new Set, this.progress = Zs(t)
        /**
    ...
    return t.prototype.Ou = function(t) {
        ...
        for (var e = new Map, n = new Ys(this.It), r = 0, i = t; r < i.length; r++) {
            var o = i[r];
            if (o.metadata.queries) for (var u = n.Ji(o.metadata.name), s = 0, a = o.metadata.queries; s < a.length; s++) {
    ...
    t.prototype.complete = function() {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return [ 4 /*yield*/ , Mu(this.localStore, new Ys(this.It), this.documents, this.Mu.id) ];

                  case 1:
                    t = n.sent(), e = this.Fu(this.documents), r = 0, i = this.queries, n.label = 2;
 ...
 */ var Js = function(t) {
    ...
    e) {
        ...
        this.mutatedKeys = wr(), this.Ku = Tn(t), this.Gu = new Ps(this.Ku);
    }
    ...
    t.prototype.ju = function(t, e) {
        var n = this, r = e ? e.Wu : new Fs, i = e ? e.Gu : this.Gu, o = e ? e.mutatedKeys : this.mutatedKeys, u = i, s = !1, a = "F" /* First */ === this.query.limitType && i.size === this.query.limit ? i.last() : null, c = "L" /* Last */ === this.query.limitType && i.size === this.query.limit ? i.first() : null;
        ...
        if (t.inorderTraversal((function(t, e) {
            ...
            l && h ? l.data.isEqual(h.data) ? f !== d && (r.track({
                type: 3 /* Metadata */ ,
                doc: h
            }), p = !0) : n.zu(l, h) || (r.track({
                type: 2 /* Modified */ ,
                doc: h
            }), p = !0, (a && n.Ku(h, a) > 0 || c && n.Ku(h, c) < 0) && (
    ...
    t.prototype.applyChanges = function(t, e, n) {
        ...
        o.sort((function(t, e) {
            return function(t, e) {
                ...
                return n(t) - n(e);
            }(t.type, e.type) || r.Ku(t.doc, e.doc);
        })), this.Hu(n);
        var u = e ? this.Ju() : [], s = 0 === this.qu.size && this.current ? 1 /* Synced */ : 0 /* Local */ , a = s !== this.Uu;
        return this.Uu = s, 0 !== o.length || a ? {
            snapshot: new qs(this.query, t.Gu, i, o, t.mutatedKeys, 0 /* Local */ === s, a, 
            /* excludesMetadataChanges= */ !1),
            Yu: u
        } : {
            Yu: u
    ...
    t.prototype.Hu = function(t) {
        ...
        // updating many documents.
                var e = this.qu;
        this.qu = wr(), this.Gu.forEach((function(e) {
            t.Xu(e.key) && (t.qu = t.qu.add(e.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        var n = [];
        return e.forEach((function(e) {
            t.qu.has(e) || n.push(new $s(e));
        })), this.qu.forEach((function(t) {
    ...
    t.prototype.Zu = function(t) {
        this.Lu = t.Hi, this.qu = wr();
        var e = this.ju(t.documents);
    ...
    t.prototype.tc = function() {
        return qs.fromInitialDocuments(this.query, this.Gu, this.mutatedKeys, 0 /* Local */ === this.Uu);
    }, t;
}(), ea = function(
/**
     * The query itself.
...
n) {
    ...
    r, i, o) {
        ...
        this.currentUser = i, this.maxConcurrentLimboResolutions = o, this.nc = {}, this.sc = new ar((function(t) {
            return wn(t);
        }), gn), this.ic = new Map, 
        /**
        ...
        /**
             ...
             * active target.
             */
        this.oc = new Ht(mt.comparator), 
        /**
             * Keeps track of the information about an active limbo resolution for each
             * active target ID that was started for the purpose of limbo resolution.
             */
        this.uc = new Map, this.cc = new iu, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.ac = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.hc = new Map, this.lc = Lo.vn(), this.onlineState = "Unknown" /* Unknown */ , 
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                ...
                i = u.targetId, e.sharedClientState.addLocalQueryTarget(i), o = u.view.tc(), [ 3 /*break*/ , 4 ]) : [ 3 /*break*/ , 1 ];

              case 1:
                return [ 4 /*yield*/ , Cu(e.localStore, yn(r)) ];
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(f) {
            switch (f.label) {
                    ...
                    return function(t, r, i, o) {
                        return e(this, void 0, void 0, (function() {
                            ...
                            return n(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return e = r.view.ju(i), e.$i ? [ 4 /*yield*/ , Ou(t.localStore, r.query, 
                                    /* usePreviousResults= */ !1).then((function(t) {
                                        var n = t.documents;
                                        return r.view.ju(n, e);
                                    })) ] : [ 3 /*break*/ , 2 ];
                                  ...
                                  case 2:
                                    ...
                                    /* updateLimboDocuments= */ t.isPrimaryClient, u), [ 2 /*return*/ , (ga(t, r.targetId, s.Yu), 
                                    s.snapshot) ];
                                }
                            }));
                        }));
              ...
              case 1:
                return u = f.sent(), s = new ta(r, u.Hi), a = s.ju(u.documents), c = Tr.createSynthesizedTargetChangeForCurrentChange(i, o && "Offline" /* Offline */ !== t.onlineState), 
                l = s.applyChanges(a, 
                /* updateLimboDocuments= */ t.isPrimaryClient, c), ga(t, i, l.Yu), h = new ea(r, i, s), 
                [ 2 /*return*/ , (t.sc.set(r, h), t.ic.has(i) ? t.ic.get(i).push(r) : t.ic.set(i, [ r ]), 
                l.snapshot) ];
            }
        }));
    }));
...
/** Stops listening to the query. */ function ua(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return e = W(t), i = e.sc.get(r), (o = e.ic.get(i.targetId)).length > 1 ? [ 2 /*return*/ , (e.ic.set(i.targetId, o.filter((function(t) {
                    return !gn(t, r);
                }))), void e.sc.delete(r)) ] : e.isPrimaryClient ? (
                // We need to remove the local query target first to allow us to verify
                // whether any other client is still interested in this target.
                e.sharedClientState.removeLocalQueryTarget(i.targetId), e.sharedClientState.isActiveQueryTarget(i.targetId) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , ku(e.localStore, i.targetId, 
              ...
              case 3:
                return ya(e, i.targetId), [ 4 /*yield*/ , ku(e.localStore, i.targetId, 
            ...
            switch (n.label) {
              ...
              case 1:
                return n.trys.push([ 1, 5, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    ...
                    return i.persistence.runTransaction("Locally write mutations", "readwrite", (function(t) {
                        ...
                        //  to 0.
                        var s = lr(), a = wr();
                        return i.Gi.getEntries(t, u).next((function(t) {
                            ...
                            var u = [], s = 0, a = e; s < a.length; s++) {
                                ...
                                // exists=true
                                u.push(new Zn(c.key, l, Pe(l.value.mapValue), Gn.exists(!0)));
                            }
              ...
              case 2:
                return o = n.sent(), e.sharedClientState.addPendingMutation(o.batchId), function(t, e, n) {
                    var r = t.ac[t.currentUser.toKey()];
                    r || (r = new Ht(at)), r = r.insert(e, n), t.ac[t.currentUser.toKey()] = r;
              ...
              case 5:
                return u = n.sent(), s = Ms(u, "Failed to persist write"), i.reject(s), [ 3 /*break*/ , 6 ];
            ...
            switch (n.label) {
              ...
              case 2:
                ...
                r.targetChanges.forEach((function(t, n) {
                    ...
                    t.addedDocuments.size > 0 ? r.ec = !0 : t.modifiedDocuments.size > 0 ? Q(r.ec) : t.removedDocuments.size > 0 && (Q(r.ec), 
                    r.ec = !1));
                })), [ 4 /*yield*/ , Ia(e, i, r) ];
 ...
 */ function ca(t, e, n) {
    ...
    // SharedClientState.
        ...
        }(r.eventManager, e), i.length && r.nc.Wo(i), r.onlineState = e, r.isPrimaryClient && r.sharedClientState.setOnlineState(e);
    }
}
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                // PORTING NOTE: Multi-tab only.
                return (e = W(t)).sharedClientState.updateQueryState(r, "rejected", i), o = e.uc.get(r), 
                (u = o && o.key) ? (
                // TODO(b/217189216): This limbo document should ideally have a read time,
                // so that it is picked up by any read-time based scans. The backend,
                // however, does not send a read time for target removals.
                s = (s = new Ht(mt.comparator)).insert(u, Fe.newNoDocument(u, ft.min())), a = wr().add(u), 
                c = new Er(ft.min(), 
                /* targetChanges= */ new Map, 
                /* targetMismatches= */ new Zt(at), s, a), [ 4 /*yield*/ , aa(e, c) ]) : [ 3 /*break*/ , 2 ];
              ...
              case 1:
                ...
                e.oc = e.oc.remove(u), e.uc.delete(r), ba(e), [ 3 /*break*/ , 4 ];

              case 2:
                return [ 4 /*yield*/ , ku(e.localStore, r, 
                /* keepPersistedTargetData */ !1).then((function() {
                    return ya(e, r, i);
                })).catch(kt) ];
                ...
                return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    ...
                    return n.persistence.runTransaction("Reject batch", "readwrite-primary", (function(t) {
                        ...
                        return n.mutationQueue.lookupMutationBatch(t, e).next((function(e) {
                            return Q(null !== e), r = e.keys(), n.mutationQueue.removeMutationBatch(t, e);
                        })).next((function() {
                            return n.mutationQueue.performConsistencyCheck(t);
                        })).next((function() {
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              ...
              case 2:
                return -1 === (i = n.sent()) ? [ 2 /*return*/ , void r.resolve() ] : ((o = e.hc.get(i) || []).push(r), 
                e.hc.set(i, o), [ 3 /*break*/ , 4 ]);

              case 3:
                return u = n.sent(), s = Ms(u, "Initialization of waitForPendingWrites() operation failed"), 
...
function va(t, e, n) {
    var r = W(t), i = r.ac[r.currentUser.toKey()];
    // NOTE: Mutations restored from persistence won't have callbacks, so it's
    // okay for there to be no callback for this ID.
    if (i) {
        var o = i.get(e);
        o && (n ? o.reject(n) : o.resolve(), i = i.remove(e)), r.ac[r.currentUser.toKey()] = i;
    }
}

function ya(t, e, n) {
    void 0 === n && (n = null), t.sharedClientState.removeLocalQueryTarget(e);
    for (var r = 0, i = t.ic.get(e); r < i.length; r++) {
        var o = i[r];
        t.sc.delete(o), n && t.nc._c(o, n);
    }
    t.ic.delete(e), t.isPrimaryClient && t.cc.ls(e).forEach((function(e) {
        t.cc.containsKey(e) || 
...
function ma(t, e) {
    ...
    var n = t.oc.get(e);
    null !== n && (fs(t.remoteStore, n), t.oc = t.oc.remove(e), t.uc.delete(n), ba(t));
}

function ga(t, e, n) {
    for (var r = 0, i = n; r < i.length; r++) {
        var o = i[r];
        o instanceof Js ? (t.cc.addReference(o.key, e), wa(t, o)) : o instanceof $s ? (U("SyncEngine", "Document no longer in limbo: " + o.key), 
        t.cc.removeReference(o.key, e), t.cc.containsKey(o.key) || 
        // We removed the last reference for this key
        ma(t, o.key)) : j();
    }
}
...
function wa(t, e) {
    ...
    t.oc.get(n) || t.rc.has(r) || (U("SyncEngine", "New document in limbo: " + n), t.rc.add(r), 
    ba(t));
}
 ...
 */ function ba(t) {
    for (;t.rc.size > 0 && t.oc.size < t.maxConcurrentLimboResolutions; ) {
        var e = t.rc.values().next().value;
        t.rc.delete(e);
        var n = new mt(pt.fromString(e)), r = t.lc.next();
        t.uc.set(r, new na(n)), t.oc = t.oc.insert(n, r), hs(t.remoteStore, new Ui(yn(ln(n.path)), r, 2 /* LimboResolution */ , jt.at));
    }
}
...
function Ia(t, r, i) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(c) {
            switch (c.label) {
              case 0:
                return o = W(t), u = [], s = [], a = [], o.sc.isEmpty() ? [ 3 /*break*/ , 3 ] : (o.sc.forEach((function(t, e) {
                    a.push(o.dc(e, r, i).then((function(t) {
                        if (t) {
                            o.isPrimaryClient && o.sharedClientState.updateQueryState(e.targetId, t.fromCache ? "not-current" : "current"), 
                            u.push(t);
                            var n = bu.Ci(e.targetId, t);
                            s.push(n);
                        }
                    })));
              ...
              case 1:
                return c.sent(), o.nc.Wo(u), [ 4 /*yield*/ , function(t, r) {
                    return e(this, void 0, void 0, (function() {
                        ...
                        return n(this, (function(n) {
                            switch (n.label) {
                              ...
                              case 1:
                                return n.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , e.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(t) {
                                    return Ot.forEach(r, (function(n) {
                                        return Ot.forEach(n.Si, (function(r) {
                                            return e.persistence.referenceDelegate.addReference(t, n.targetId, r);
                                        })).next((function() {
                                            return Ot.forEach(n.Di, (function(r) {
                              ...
                              case 4:
                                for (o = 0, u = r; o < u.length; o++) s = u[o], a = s.targetId, s.fromCache || (c = e.Ui.get(a), 
                                l = c.snapshotVersion, h = c.withLastLimboFreeSnapshotVersion(l), 
                                // Advance the last limbo free snapshot version
                                e.Ui = e.Ui.insert(a, h));
                                return [ 2 /*return*/ ];
                            }
                        }));
                    }));
        ...
        return n(this, (function(n) {
            switch (n.label) {
              ...
              case 1:
                ...
                e.sharedClientState.handleUserChange(r, i.removedBatchIds, i.addedBatchIds), [ 4 /*yield*/ , Ia(e, i.ji) ];
...
function Ta(t, e) {
    var n = W(t), r = n.uc.get(e);
    if (r && r.ec) return wr().add(r.key);
    var i = wr(), o = n.ic.get(e);
    if (!o) return i;
    for (var u = 0, s = o; u < s.length; u++) {
        var a = s[u], c = n.sc.get(a);
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              ...
              case 1:
                return i = n.sent(), o = r.view.Zu(i), [ 2 /*return*/ , (e.isPrimaryClient && ga(e, r.targetId, o.Yu), 
                o) ];
            }
        }));
    }));
...
function Da(t, r) {
    return e(this, void 0, void 0, (function() {
        var e;
        return n(this, (function(n) {
            return [ 2 /*return*/ , Lu((e = W(t)).localStore, r).then((function(t) {
                return Ia(e, t);
            })) ];
        }));
    }));
...
function _a(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return Va(e = W(t)), La(e), !0 !== r || !0 === e.fc ? [ 3 /*break*/ , 3 ] : (i = e.sharedClientState.getAllActiveQueryTargets(), 
                [ 4 /*yield*/ , Na(e, i.toArray()) ]);

              case 1:
                return o = n.sent(), e.fc = !0, [ 4 /*yield*/ , Os(e.remoteStore, !0) ];
              ...
              case 5:
                ...
                function(t) {
                    var e = W(t);
                    e.uc.forEach((function(t, n) {
                        fs(e.remoteStore, n);
                    })), e.cc.fs(), e.uc = new Map, e.oc = new Ht(mt.comparator);
                }(e), e.fc = !1, [ 4 /*yield*/ , Os(e.remoteStore, !1) ];
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              ...
              case 1:
                return u < s.length ? (a = s[u], c = void 0, (l = e.ic.get(a)) && 0 !== l.length ? [ 4 /*yield*/ , Cu(e.localStore, yn(l[0])) ] : [ 3 /*break*/ , 7 ]) : [ 3 /*break*/ , 13 ];
              ...
              case 3:
                return h < f.length ? (d = f[h], p = e.sc.get(d), [ 4 /*yield*/ , Sa(e, p) ]) : [ 3 /*break*/ , 6 ];
              ...
              case 8:
                return y = n.sent(), [ 4 /*yield*/ , Cu(e.localStore, y) ];
...
function Ca(t) {
    var e = W(t);
    return W(W(e.localStore).persistence).vi();
}
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                ...
                if (!((u = e.ic.get(r)) && u.length > 0)) return [ 3 /*break*/ , 7 ];
                switch (i) {
                  case "current":
                  case "not-current":
                    return [ 3 /*break*/ , 1 ];
              ...
              case 1:
                return [ 4 /*yield*/ , Lu(e.localStore, En(u[0])) ];
...
/** Adds or removes Watch targets for queries from different tabs. */ function Oa(t, r, i) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(p) {
            switch (p.label) {
              case 0:
                if (!(e = Va(t)).fc) return [ 3 /*break*/ , 10 ];
                o = 0, u = r, p.label = 1;

              case 1:
                return o < u.length ? (s = u[o], e.ic.has(s) ? (
                // A target might have been added in a previous attempt
                U("SyncEngine", "Adding an already active target " + s), [ 3 /*break*/ , 5 ]) : [ 4 /*yield*/ , Vu(e.localStore, s) ]) : [ 3 /*break*/ , 6 ];

              case 2:
                return a = p.sent(), [ 4 /*yield*/ , Cu(e.localStore, a) ];
              ...
              case 6:
                l = function(t) {
                    return n(this, (function(n) {
                        switch (n.label) {
                          case 0:
                            return e.ic.has(t) ? [ 4 /*yield*/ , ku(e.localStore, t, 
                            /* keepPersistedTargetData */ !1).then((function() {
...
function Va(t) {
    ...
    e.remoteStore.remoteSyncer.rejectListen = la.bind(null, e), e.nc.Wo = js.bind(null, e.eventManager), 
    e.nc._c = Qs.bind(null, e.eventManager), e;
}
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 4:
                    return i._updateProgress(Zs(e)), o = new Xs(e, t.localStore, r.It), [ 4 /*yield*/ , r.wc() ];

                  case 5:
                    u = n.sent(), n.label = 6;

                  case 6:
                    return u ? [ 4 /*yield*/ , o.Ou(u) ] : [ 3 /*break*/ , 10 ];

                  case 7:
                    return (s = n.sent()) && i._updateProgress(s), [ 4 /*yield*/ , r.wc() ];
                  ...
                  case 11:
                    return a = n.sent(), [ 4 /*yield*/ , Ia(t, a.Bu, 
                    /* remoteEvent */ void 0) ];
                  ...
                  case 13:
                    return [ 2 /*return*/ , (
                    // Save metadata, so loading the same bundle will skip.
                    n.sent(), i._completeWith(a.progress), Promise.resolve(a.$u)) ];

                  case 14:
                    return [ 2 /*return*/ , (G("SyncEngine", "Loading bundle failed with " + (c = n.sent())), 
...
var Ma = /** @class */ function() {
    ...
    return t.prototype.initialize = function(t) {
        return e(this, void 0, void 0, (function() {
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return this.It = es(t.databaseInfo.databaseId), this.sharedClientState = this.mc(t), 
                    this.persistence = this.gc(t), [ 4 /*yield*/ , this.persistence.start() ];

                  case 1:
                    return e.sent(), this.localStore = this.yc(t), this.gcScheduler = this.Ic(t, this.localStore), 
                    this.indexBackfillerScheduler = this.Tc(t, this.localStore), [ 2 /*return*/ ];
                }
            }));
        }));
        ...
        return Tu(this.persistence, new Iu, t.initialUser, this.It);
    }, t.prototype.gc = function(t) {
        return new lu(fu.Bs, this.It);
    ...
    function i(t, e, n) {
        var i = this;
        return (i = r.call(this) || this).Ec = t, i.cacheSizeBytes = e, i.forceOwnership = n, 
    ...
    return t(i, r), i.prototype.initialize = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return n.sent(), [ 4 /*yield*/ , this.Ec.initialize(this, t) ];

                  case 2:
                    // Enqueue writes from a previous session
                    return n.sent(), [ 4 /*yield*/ , La(this.Ec.syncEngine) ];

                  case 3:
                    // Enqueue writes from a previous session
                    return n.sent(), [ 4 /*yield*/ , Ss(this.Ec.remoteStore) ];

                  case 4:
                    // NOTE: This will immediately call the listener, so we make sure to
                    // set it after localStore / remoteStore are started.
                    return n.sent(), [ 4 /*yield*/ , this.persistence.li((function() {
        ...
        return new yu(this.synchronizeTabs, e, t.clientId, n, t.asyncQueue, $u(), ts(), this.It, this.sharedClientState, !!this.forceOwnership);
    }, i.prototype.mc = function(t) {
        return new Wu;
    }, i;
}(Ma), Fa = /** @class */ function(r) {
    function i(t, e) {
        var n = this;
        return (n = r.call(this, t, e, /* forceOwnership= */ !1) || this).Ec = t, n.cacheSizeBytes = e, 
    ...
    return t(i, r), i.prototype.initialize = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(u) {
                switch (u.label) {
                  ...
                  case 1:
                    return u.sent(), i = this.Ec.syncEngine, this.sharedClientState instanceof zu ? (this.sharedClientState.syncEngine = {
                        Fr: xa.bind(null, i),
                        $r: ka.bind(null, i),
                        Br: Oa.bind(null, i),
                        vi: Ca.bind(null, i),
                  ...
                  case 3:
                    // NOTE: This will immediately call the listener, so we make sure to
                    // set it after localStore / remoteStore are started.
                    return [ 4 /*yield*/ , this.persistence.li((function(t) {
                        return e(o, void 0, void 0, (function() {
                            return n(this, (function(e) {
                                switch (e.label) {
                                  case 0:
                                    return [ 4 /*yield*/ , _a(this.Ec.syncEngine, t) ];
        ...
        var e = $u();
        if (!zu.C(e)) throw new Y(H.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
        var n = wu(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey);
        return new zu(e, t.asyncQueue, n, t.clientId, t.initialUser);
    }, i;
}(Pa), qa = /** @class */ function() {
    function t() {}
    return t.prototype.initialize = function(t, r) {
        ...
        var e, n = es(t.databaseInfo.databaseId), r = (e = t.databaseInfo, new Ju(e));
        ...
        }, o = Yu.C() ? new Yu : new Hu, new as(e, n, r, i, o);
        ...
        return function(t) {
            return e(this, void 0, void 0, (function() {
                ...
                return n(this, (function(n) {
                    switch (n.label) {
                      case 0:
                        return e = W(t), U("RemoteStore", "RemoteStore shutting down."), e._u.add(5 /* Shutdown */), 
                        [ 4 /*yield*/ , ls(e) ];
 ...
 */ var Ba = /** @class */ function() {
    ...
    return t.prototype.next = function(t) {
        ...
        this.observer.error ? this.Ac(this.observer.error, t) : B("Uncaught Error in snapshot listener:", t);
    ...
    t, e) {
        ...
        this.vc().then((function(t) {
            t && t.ku() ? n.metadata.resolve(t.payload.metadata) : n.metadata.reject(new Error("The first element of the bundle is not a metadata, it is\n             " + JSON.stringify(null == t ? void 0 : t.payload)));
        }), (function(t) {
            ...
            return n(this, (function(t) {
                switch (t.label) {
                  ...
                  case 1:
                    ...
                    return [ 2 /*return*/ , (t.sent(), this.vc()) ];
                }
            }));
        }));
    }, 
    ...
    t.prototype.vc = function() {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return [ 4 /*yield*/ , this.Vc() ];

                  case 1:
                    return null === (t = n.sent()) ? [ 2 /*return*/ , null ] : (e = this.Pc.decode(t), 
                    r = Number(e), isNaN(r) && this.Sc("length string (" + e + ") is not valid number"), 
                    [ 4 /*yield*/ , this.Dc(r) ]);
    ...
    /** First index of '{' from the underlying buffer. */ t.prototype.Cc = function() {
    ...
    t.prototype.Vc = function() {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.Cc() < 0 ? [ 4 /*yield*/ , this.xc() ] : [ 3 /*break*/ , 3 ];
                  ...
                  case 3:
                    ...
                    (t = this.Cc()) < 0 && this.Sc("Reached the end of bundle when a length string is expected."), 
    ...
    t.prototype.Dc = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.buffer.length < t ? [ 4 /*yield*/ , this.xc() ] : [ 3 /*break*/ , 3 ];
                  ...
                  case 3:
                    ...
                    return e = this.Pc.decode(this.buffer.slice(0, t)), [ 2 /*return*/ , (this.buffer = this.buffer.slice(t), 
                    e) ];
                }
            }));
        }));
                    ...
                    return [ 4 /*yield*/ , function(t, r) {
                        return e(this, void 0, void 0, (function() {
                            ...
                            return n(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return e = W(t), i = jr(e.It) + "/documents", o = {
                                    ...
                                    return u = n.sent(), s = new Map, u.forEach((function(t) {
                                        var n = function(t, e) {
                                            return "found" in e ? function(t, e) {
                                                ...
                                                var n = Br(t, e.found.name), r = Pr(e.found.updateTime), i = new Me({
                                                    mapValue: {
                                                        fields: e.found.fields
                                                    }
                                                });
                                                return Fe.newFoundDocument(n, r, i);
                                            }(t, e) : "missing" in e ? function(t, e) {
                                                Q(!!e.missing), Q(!!e.readTime);
                                                var n = Br(t, e.missing), r = Pr(e.readTime);
                                                return Fe.newNoDocument(n, r);
                                            }(t, e) : j();
                                        }(e.It, t);
    ...
    function t(t, e, n, r, i) {
        ...
        this.deferred = i, this.Nc = n.maxAttempts, this.xo = new ns(this.asyncQueue, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.run = function() {
        ...
        this.xo.Ao((function() {
            return e(t, void 0, void 0, (function() {
                var t, e, r = this;
                return n(this, (function(n) {
                    return t = new Ka(this.datastore), (e = this.Mc(t)) && e.then((function(e) {
        ...
        var e = this;
        this.Nc > 0 && this.Fc(t) ? (this.Nc -= 1, this.asyncQueue.enqueueAndForget((function() {
            return e.kc(), Promise.resolve();
    ...
    i, o) {
        ...
        this.user = R.UNAUTHENTICATED, this.clientId = st.R(), this.authCredentialListener = function() {
            return Promise.resolve();
            ...
            switch (n.label) {
              ...
              case 3:
                ...
                t.setCredentialChangeListener((function(t) {
                    return ks(r.remoteStore, t);
                })), t.setAppCheckTokenChangeListener((function(t, e) {
                    return ks(r.remoteStore, e);
    ...
    return Object.defineProperty(t.prototype, "app", {
        ...
        this._settings = new hc(t), void 0 !== t.credentials && (this._authCredentials = function(t) {
            ...
            switch (t.type) {
              case "gapi":
                var e = t.client;
                return new nt(e, t.sessionIndex || "0", t.iamToken || null, t.authTokenFactory || null);
...
function dc(t, e, n, r) {
    ...
    if ("firestore.googleapis.com" !== o.host && o.host !== e && G("Host has been set in both settings() and useEmulator(), emulator host will be used"), 
    t._setSettings(Object.assign(Object.assign({}, o), {
        ...
        t._authCredentials = new $(new Z(u, s));
    }
}
...
function wc(t, e) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = st.R()), ic("doc", "path", e), t instanceof fc) {
        var o = pt.fromString.apply(pt, r([ e ], n));
...
var Ec = /** @class */ function() {
    function t() {
        ...
        this.xo = new ns(this, "async_queue_retry" /* AsyncQueueRetry */), 
        // Visibility handler that triggers an immediate retry of all retryable
        // operations. Meant to speed up recovery when we regain file system access
        // after page comes into foreground.
        this.jc = function() {
            var e = ts();
            e && U("AsyncQueue", "Visibility state changed to " + e.visibilityState), t.xo.bo();
        };
        var e = ts();
        e && "function" == typeof e.addEventListener && e.addEventListener("visibilitychange", this.jc);
    }
    ...
    t.prototype.enqueueAndForget = function(t) {
        ...
        // advance the queue even when the operation is not run.
                var n = new X;
        return this.zc((function() {
            return e.Lc && e.Gc ? Promise.resolve() : (t().then(n.resolve, n.reject), n.promise);
        })).then((function() {
            return n.promise;
        }));
    ...
    t.prototype.Hc = function() {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    if (0 === this.Bc.length) return [ 3 /*break*/ , 5 ];
                    n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , this.Bc[0]() ];

                  case 2:
                    return n.sent(), this.Bc.shift(), this.xo.reset(), [ 3 /*break*/ , 4 ];
        ...
        var e = this, n = this.$c.then((function() {
            return e.Kc = !0, t().catch((function(t) {
                e.qc = t, e.Kc = !1;
                var n = 
                /**
 ...
 */
    ...
    t.prototype.Yc = function() {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return [ 4 /*yield*/ , t = this.$c ];

                  case 1:
                    e.sent(), e.label = 2;

                  case 2:
                    if (t !== this.$c) return [ 3 /*break*/ , 0 ];
                    e.label = 3;
    ...
    t.prototype.Xc = function(t) {
        for (var e = 0, n = this.Uc; e < n.length; e++) {
    ...
    t.prototype.Zc = function(t) {
        ...
        // Note that draining may generate more delayed ops, so we do that first.
                return this.Yc().then((function() {
            // Run ops in the same order they'd run if they ran naturally.
            e.Uc.sort((function(t, e) {
                return t.targetTimeMs - e.targetTimeMs;
            }));
            for (var n = 0, r = e.Uc; n < r.length; n++) {
                var i = r[n];
    ...
    /** Called once a DelayedOperation is run or canceled. */ t.prototype.Jc = function(t) {
...
function Cc(t) {
    ...
    t._firestoreClient = new Qa(t._authCredentials, t._appCheckCredentials, t._queue, r);
}
 ...
 */ function kc(t, e) {
    ...
    return Vc(n, i, new Pa(i, r.cacheSizeBytes, null == e ? void 0 : e.forceOwnership));
}
 ...
 */ function Oc(t) {
    ...
    return Vc(e, r, new Fa(r, n.cacheSizeBytes));
}
    ...
    return t.asyncQueue.enqueue((function() {
        return e(o, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return n.trys.push([ 0, 3, , 4 ]), [ 4 /*yield*/ , za(t, i) ];
         ...
         */
                    ...
                    return G("Error enabling offline persistence. Falling back to persistence disabled: " + o), 
                    ...
                    return o.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , function(t) {
                        return e(this, void 0, void 0, (function() {
                            ...
                            return n(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return Lt.C() ? (e = t + "main", [ 4 /*yield*/ , Lt.delete(e) ]) : [ 2 /*return*/ , Promise.resolve() ];
            ...
            return e(r, void 0, void 0, (function() {
                ...
                return n(this, (function(n) {
                    switch (n.label) {
                      ...
                      case 1:
                        return e = n.sent(), [ 4 /*yield*/ , Ja(t) ];

                      case 2:
                        return r = n.sent(), [ 2 /*return*/ , (e.setNetworkEnabled(!0), function(t) {
                            var e = W(t);
                            return e._u.delete(0 /* UserDisabled */), cs(e);
                        }(r)) ];
                    }
                }));
            }));
                        ...
                        return i = o.sent(), [ 2 /*return*/ , (r.setNetworkEnabled(!1), function(t) {
                            return e(this, void 0, void 0, (function() {
                                ...
                                return n(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = W(t))._u.add(0 /* UserDisabled */), [ 4 /*yield*/ , ls(e) ];
...
function(t) {
    ...
    return t.prototype.toMutation = function(t, e) {
        return null !== this.fieldMask ? new Zn(t, this.data, this.fieldMask, e, this.fieldTransforms) : new Xn(t, this.data, e, this.fieldTransforms);
    }, t;
}(), Yc = /** @class */ function() {
    function t(t, 
    ...
    return t.prototype.toMutation = function(t, e) {
        return new Zn(t, this.data, this.fieldMask, e, this.fieldTransforms);
    }, t;
}();
...
/** A "context" object passed around while parsing user data. */ var Zc = /** @class */ function() {
    /**
     ...
     */
    function t(t, e, n, r, i, o) {
        this.settings = t, this.databaseId = e, this.It = n, this.ignoreUndefinedProperties = r, 
        // Minor hack: If fieldTransforms is undefined, we assume this is an
        // external call and we need to validate the entire path.
        void 0 === i && this.ea(), this.fieldTransforms = i || [], this.fieldMask = o || [];
    }
    return Object.defineProperty(t.prototype, "path", {
        ...
        enumerable: !1,
        configurable: !0
    }), Object.defineProperty(t.prototype, "na", {
        get: function() {
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.sa = function(e) {
        return new t(Object.assign(Object.assign({}, this.settings), e), this.databaseId, this.It, this.ignoreUndefinedProperties, this.fieldTransforms, this.fieldMask);
    }, t.prototype.ia = function(t) {
        var e, n = null === (e = this.path) || void 0 === e ? void 0 : e.child(t), r = this.sa({
            path: n,
            ra: !1
        });
        return r.oa(t), r;
        ...
        return ml(t, this.settings.methodName, this.settings.ha || !1, this.path, this.settings.la);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        // within arrays.
        if (this.path) for (var t = 0; t < this.path.length; t++) this.oa(this.path.get(t));
    }, t.prototype.oa = function(t) {
        if (0 === t.length) throw this.aa("Document fields must not be empty");
        if (Xc(this.na) && Wc.test(t)) throw this.aa('Document fields cannot begin and end with "__"');
    }, t;
}(), Jc = /** @class */ function() {
    function t(t, e, n) {
        this.databaseId = t, this.ignoreUndefinedProperties = e, this.It = n || es(t)
        /** Creates a new top-level parse context. */;
    }
    return t.prototype.fa = function(t, e, n, r) {
        return void 0 === r && (r = !1), new Zc({
            na: t,
            methodName: e,
            la: n,
            path: yt.emptyPath(),
...
/** Parse document data from a set() call. */ function tl(t, e, n, r, i, o) {
    void 0 === o && (o = {});
    var u = t.fa(o.merge || o.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
...
}(Qc), il = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t) || this).da = n, r;
    }
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        var e = nl(this, t, 
        /*array=*/ !0), n = this.da.map((function(t) {
            return ll(t, e);
        })), r = new Vn(n);
...
}(Qc), ul = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t) || this)._a = n, r;
    }
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        var e = new Pn(t.It, _n(t.It, this._a));
...
/** Parse update data from a list of field/value arguments. */ function al(t, e, n, r, i, o) {
    var u = t.fa(1 /* Update */ , e, n), s = [ pl(e, r, n) ], a = [ i ];
    ...
    for (var l = [], h = Me.empty(), f = s.length - 1; f >= 0; --f) if (!gl(l, s[f])) {
        var d = s[f], p = a[f];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        p = I(p);
 ...
 */ function cl(t, e, n, r) {
    return void 0 === r && (r = !1), ll(n, t.fa(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function ll(t, e) {
    ...
    return function(t, e) {
        ...
        if (!Xc(e.na)) throw e.aa(t._methodName + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        if ("number" == typeof t) return _n(e.It, t);
        ...
        if (t instanceof jc) return {
            bytesValue: Rr(e.It, t._byteString)
        };
        if (t instanceof pc) {
            var i = e.databaseId, o = t.firestore._databaseId;
            if (!o.isEqual(i)) throw e.aa("Document reference is for database " + o.projectId + "/" + o.database + " but should be for database " + i.projectId + "/" + i.database);
            return {
                referenceValue: Fr(t.firestore._databaseId || e.databaseId, t._key.path)
            };
        }
        throw e.aa("Unsupported field value: " + ac(t));
    }(t, e);
}
...
function hl(t, e) {
    ...
    e.path && e.path.length > 0 && e.fieldMask.push(e.path) : zt(t, (function(t, r) {
        var i = ll(r, e.ia(t));
        null != i && (n[t] = i);
    })), {
        mapValue: {
...
function fl(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof ht || t instanceof zc || t instanceof jc || t instanceof pc || t instanceof Qc);
}
 ...
 */ function pl(t, e, n) {
    ...
    // FieldPath.
    (e = I(e)) instanceof Gc) return e._internalPath;
 ...
 */ function yl(t, e, n) {
    ...
    /* path= */ void 0, n);
    try {
        return (new (Gc.bind.apply(Gc, r([ void 0 ], e.split(".")))))._internalPath;
    } catch (r) {
 ...
 */
function Il(t, e) {
    return "string" == typeof e ? yl(t, e) : e instanceof Gc ? e._internalPath : e._delegate._internalPath;
}
...
var kl = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this) || this).wa = t, i.ma = n, i.ga = r, i.type = "where", 
        i;
    }
    return t(n, e), n.prototype._apply = function(t) {
        var e = $c(t.firestore), n = function(t, e, n, r, i, o, u) {
            var s;
            if (i.isKeyField()) {
            ...
            } else "in" /* IN */ !== o && "not-in" /* NOT_IN */ !== o && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== o || zl(u, o), 
            s = cl(n, "where", u, 
 ...
 */
        ...
        }(t._query, 0, e, t.firestore._databaseId, this.wa, this.ma, this.ga);
...
var Vl = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).wa = t, r.ya = n, r.type = "orderBy", r;
    }
    return t(n, e), n.prototype._apply = function(t) {
...
var Rl = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this) || this).type = t, i.pa = n, i.Ia = r, i;
    }
    return t(n, e), n.prototype._apply = function(t) {
        return new vc(t.firestore, t.converter, mn(t._query, this.pa, this.Ia));
    }, n;
}(Al);
...
var Fl = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._apply = function(t) {
        var e = jl(t, this.type, this.Ta, this.Ea);
        return new vc(t.firestore, t.converter, function(t, e) {
...
function ql() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new Fl("startAt", t, 
    /*inclusive=*/ !0);
}

function Ul() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new Fl("startAfter", t, 
    /*inclusive=*/ !1);
}
 ...
 */ var Hl = {
    ...
    return t.prototype.convertValue = function(t, e) {
        ...
        return new zc(oe(t.latitude), oe(t.longitude));
...
var Zl = /** @class */ function(e) {
...
}(Yl), Jl = /** @class */ function() {
    /** @hideconstructor */
    function t(t, e) {
        this._firestore = t, this._commitHandler = e, this._mutations = [], this._committed = !1, 
        this._dataReader = $c(t);
    }
    return t.prototype.set = function(t, e, n) {
        this._verifyNotCommitted();
        var r = $l(t, this._firestore), i = Xl(r.converter, e, n), o = tl(this._dataReader, "WriteBatch.set", r._key, i, null !== r.converter, n);
        return this._mutations.push(o.toMutation(r._key, Gn.none())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
        this._verifyNotCommitted();
        var o, u = $l(t, this._firestore);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = I(e)) || e instanceof Gc ? al(this._dataReader, "WriteBatch.update", u._key, e, n, r) : sl(this._dataReader, "WriteBatch.update", u._key, e), 
        this._mutations.push(o.toMutation(u._key, Gn.exists(!0))), this;
    }, 
    /**
    ...
    t.prototype.delete = function(t) {
        this._verifyNotCommitted();
        var e = $l(t, this._firestore);
        return this._mutations = this._mutations.concat(new rr(e._key, Gn.none())), this;
    }, 
    /**
                            ...
                            return e(this, void 0, void 0, (function() {
                                ...
                                return n(this, (function(n) {
                                    switch (n.label) {
                                      ...
                                      case 2:
                                        return o = n.sent(), u = Ms(o, "Failed to get document '" + r + " from cache"), 
                            ...
                            return e(this, void 0, void 0, (function() {
                                ...
                                return n(this, (function(n) {
                                    switch (n.label) {
                                      ...
                                      case 1:
                                        return e = n.sent(), o = new ta(r, e.Hi), u = o.ju(e.documents), s = o.applyChanges(u, 
                                        /* updateLimboDocuments= */ !1), i.resolve(s.snapshot), [ 3 /*break*/ , 3 ];

                                      case 2:
                                        return a = n.sent(), c = Ms(a, "Failed to execute query '" + r + " against cache"), 
...
function sh(t, e, n) {
    t = cc(t, pc);
    var r = cc(t.firestore, xc), i = Xl(t.converter, e, n);
    return dh(r, [ tl($c(r), "setDoc", t._key, i, null !== t.converter, n).toMutation(t._key, Gn.none()) ]);
}

function ah(t, e, n) {
    for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
    t = cc(t, pc);
    var o = cc(t.firestore, xc), u = $c(o);
    return dh(o, [ ("string" == typeof (
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = I(e)) || e instanceof Gc ? al(u, "updateDoc", t._key, e, n, r) : sl(u, "updateDoc", t._key, e)).toMutation(t._key, Gn.exists(!0)) ]);
}
 ...
 */ function ch(t) {
    return dh(cc(t.firestore, xc), [ new rr(t._key, Gn.none()) ]);
}
 ...
 */ function lh(t, e) {
    var n = cc(t.firestore, xc), r = wc(t), i = Xl(t.converter, e);
    return dh(n, [ tl($c(t.firestore), "addDoc", r._key, i, null !== t.converter, {}).toMutation(r._key, Gn.exists(!1)) ]).then((function() {
        return r;
    }));
}
...
function hh(t) {
    ...
    return function(t, r, i, o) {
        ...
        return t.asyncQueue.enqueueAndForget((function() {
            ...
            s.Rc(), t.asyncQueue.enqueueAndForget((function() {
                return e(u, void 0, void 0, (function() {
                    var e;
                    return n(this, (function(n) {
                        switch (n.label) {
...
function fh(t, r) {
    return function(t, r) {
        ...
        return t.asyncQueue.enqueueAndForget((function() {
            ...
            o.Rc(), t.asyncQueue.enqueueAndForget((function() {
                return e(i, void 0, void 0, (function() {
                    var e;
                    return n(this, (function(n) {
                        switch (n.label) {
 ...
 */ var vh, yh = /** @class */ function(e) {
     ...
     */    return t(n, e), n.prototype.get = function(t) {
        var n = this, r = $l(t, this._firestore), i = new eh(this._firestore);
    ...
    /** @hideconstructor */
    function t(t, e) {
        this._firestore = t, this._transaction = e, this._dataReader = $c(t)
        /**
     * Reads the document referenced by the provided {@link DocumentReference}.
     *
     * @param documentRef - A reference to the document to be read.
    ...
    return t.prototype.get = function(t) {
        var e = this, n = $l(t, this._firestore), r = new Zl(this._firestore);
        ...
        var r = $l(t, this._firestore), i = Xl(r.converter, e, n), o = tl(this._dataReader, "Transaction.set", r._key, i, null !== r.converter, n);
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = I(e)) || e instanceof Gc ? al(this._dataReader, "Transaction.update", u._key, e, n, r) : sl(this._dataReader, "Transaction.update", u._key, e), 
 ...
 * writes.
 */ function Th(t) {
    return Ac(t = cc(t, xc)), new Jl(t, (function(e) {
        return dh(t, e);
    }))
    /**
 * @license
...
function Sh(t, i) {
    ...
    if (!(null === (o = u.offlineComponents) || void 0 === o ? void 0 : o.indexBackfillerScheduler)) return G("Cannot enable indexes when persistence is disabled"), 
    Promise.resolve();
    var s = function(t) {
