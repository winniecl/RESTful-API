 ...
 */ class X {
    constructor(t, e, n, s) {
        this.h = t, this.l = e, this.m = n, this.g = s, this.type = "FirstParty", this.user = x.FIRST_PARTY, 
        this.p = new Map;
    }
 ...
 */ class Z {
    ...
    getToken() {
        return Promise.resolve(new X(this.h, this.l, this.m, this.g));
    }
    start(t, e) {
...
class et {
    ...
    start(t, e) {
        const n = t => {
            ...
            return this.A = t.token, F("FirebaseAppCheckTokenProvider", `Received ${n ? "new" : "existing"} token.`), 
    ...
    getToken() {
        ...
        this.A = t.token, new tt(t.token)) : null)) : Promise.resolve(null);
    }
    invalidateToken() {
        this.forceRefresh = !0;
    }
...
class Dt {
    constructor(t, e) {
         ...
         */
        this.P = new W, this.transaction.oncomplete = () => {
            this.P.resolve();
        }, this.transaction.onabort = () => {
            e.error ? this.P.reject(new Nt(t, e.error)) : this.P.resolve();
        }, this.transaction.onerror = e => {
            const n = $t(e.target.error);
            this.P.reject(new Nt(t, n));
        };
    }
    static open(t, e, n, s) {
        try {
    ...
    abort(t) {
        t && this.P.reject(t), this.aborted || (F("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"), 
 ...
 */ class Ct {
    ...
    constructor(t, e, n) {
        ...
        // log on 12.2.
        12.2 === Ct.D(a()) && $("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    ...
    /** Returns true if IndexedDB is available in the current environment. */    static C() {
        ...
        // Check the UA string to find out the browser.
                const t = a(), e = Ct.D(t), n = 0 < e && e < 10, s = Ct.k(t), i = 0 < s && s < 4.5;
        // IE 10
    ...
    async runTransaction(t, e, n, s) {
        ...
        for (;;) {
            ...
            try {
                ...
                const e = Dt.open(this.db, t, i ? "readonly" : "readwrite", n), r = s(e).next((t => (e.V(), 
                t))).catch((t => (
...
class Bt {
    ...
    nt(t) {
        F("IndexBackiller", `Scheduled in ${t}ms`), this.task = this.asyncQueue.enqueueAfterDelay("index_backfill" /* IndexBackfill */ , t, (async () => {
            this.task = null;
            try {
                F("IndexBackiller", `Documents written: ${await this.et.st()}`);
            } catch (t) {
...
/** Implements the steps for backfilling indexes. */ class Lt {
     ...
     */    rt(t, e, n) {
        ...
        return this.localStore.indexManager.getMinOffsetFromCollectionGroup(t, e).next((s => this.localStore.localDocuments.getNextDocuments(t, e, s, n).next((n => {
            const i = n.changes;
            return this.localStore.indexManager.updateIndexEntries(t, i).next((() => this.ot(s, n))).next((n => (F("IndexBackiller", `Updating offset: ${n}`), 
...
/** Returns the number of segments of a perfect index for this target. */ class je extends class {} {
     ...
     */    static create(t, e, n) {
        return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.lt(t, e, n) : new We(t, e, n) : "array-contains" /* ARRAY_CONTAINS */ === e ? new Ye(t, n) : "in" /* IN */ === e ? new Xe(t, n) : "not-in" /* NOT_IN */ === e ? new Ze(t, n) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new tn(t, n) : new je(t, e, n);
    }
    static lt(t, e, n) {
    ...
    matches(t) {
        ...
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.ft(ye(e, this.value)) : null !== e && we(this.value) === we(e) && this.ft(ye(e, this.value));
 ...
 */ function _n(t) {
    ...
    if (null === e._t) {
        ...
        t.isKeyField() || e._t.push(new nn(t)), e._t.push(new nn(dt.keyField(), "asc" /* ASCENDING */)); else {
            let t = !1;
            ...
            if (!t) {
                ...
                e._t.push(new nn(dt.keyField(), t));
            }
        }
    }
    return e._t;
 ...
 */ function wn(t) {
    const e = G(t);
    if (!e.wt) if ("F" /* First */ === e.limitType) e.wt = $e(e.path, e.collectionGroup, _n(e), e.filters, e.limit, e.startAt, e.endAt); else {
        ...
        e.wt = $e(e.path, e.collectionGroup, t, e.filters, e.limit, n, s);
    }
    return e.wt;
}
 ...
 */ function Vn(t, e, n) {
    return t instanceof Cn ? function(t, e) {
        ...
        const n = Dn(t, e), s = Fn(n) + Fn(t.yt);
        return Ae(n) && Ae(t.yt) ? bn(s) : Rn(t.It, s);
    }(t, e);
}
...
function Ln(t, e) {
    return t.field.isEqual(e.field) && function(t, e) {
        return t instanceof xn && e instanceof xn || t instanceof kn && e instanceof kn ? ot(t.elements, e.elements, me) : t instanceof On && e instanceof On ? me(t.yt, e.yt) : t instanceof Cn && e instanceof Cn;
...
/** Tracks the internal state of a Watch target. */ class vs {
    constructor() {
        ...
        this.Pt = te.EMPTY_BYTE_STRING, this.vt = !1, 
        /**
     ...
     */    xt() {
        ...
        })), new As(this.Pt, this.vt, t, e, n);
    }
    /**
     * Resets the document changes and sets `hasPendingChanges` to false.
     */    Nt() {
        this.Vt = !1, this.bt = Ds();
    }
    kt(t, e) {
...
class Vs {
     ...
     */    Yt(t) {
        ...
        if (s) {
            ...
            if (qe(t)) if (0 === n) {
                ...
                this.jt(e, n, Oe.newNoDocument(n, at.min()));
            } else q(1 === n); else {
                this.Zt(e) !== n && (
     ...
     */    te(t) {
        ...
        this.Lt.forEach(((n, s) => {
            ...
            if (i) {
                if (n.current && qe(i.target)) {
                    ...
                    null !== this.Ut.get(e) || this.ee(s, e) || this.jt(s, e, Oe.newNoDocument(e, t));
                }
        ...
        const s = new Es(t, e, this.Kt, this.Ut, n);
        return this.Ut = hs(), this.qt = Ss(), this.Kt = new zt(rt), s;
    }
    /**
    ...
    zt(t) {
        let e = this.Lt.get(t);
        return e || (e = new vs, this.Lt.set(t, e)), e;
    }
    ne(t) {
        let e = this.qt.get(t);
...
function Hs(t, e) {
    ...
    if ("targetChange" in e) {
        ...
        const s = function(t) {
            ...
            return t.gt ? (q(void 0 === e || "string" == typeof e), te.fromBase64String(e || "")) : (q(void 0 === e || e instanceof Uint8Array), 
...
/** Decodes a remote document from storage locally to a Document. */ function ji(t, e) {
    let n;
    if (e.document) n = Ws(t.re, e.document, !!e.hasCommittedMutations); else if (e.noDocument) {
...
function Yi(t, e) {
    const n = (e.baseMutations || []).map((e => Ys(t.re, e)));
    ...
    const s = e.mutations.map((e => Ys(t.re, e))), i = ct.fromMillis(e.localWriteTimeMs);
...
/** Encodes TargetData into a DbTarget for storage locally. */ function Zi(t, e) {
    ...
    let i;
    i = qe(e.target) ? Zs(t.re, e.target) : ti(t.re, e.target);
...
function er(t, e) {
    return new Ki(e.largestBatchId, Ys(t.re, e.overlayMutation));
}
 ...
 */ class ur {
    ...
    getOverlay(t, e) {
        return cr(t).get(nr(this.userId, e)).next((t => t ? er(this.It, t) : null));
    }
    getOverlays(t, e) {
        const n = _s();
    ...
    removeOverlaysForBatchId(t, e, n) {
        ...
        return s.forEach((e => {
            ...
            /*lowerOpen=*/ !1, 
            /*upperOpen=*/ !0);
            i.push(cr(t).Y("collectionPathOverlayIndex", s));
        })), St.waitFor(i);
    }
    getOverlaysForCollection(t, e, n) {
        const s = _s(), i = fi(e), r = IDBKeyRange.bound([ this.userId, i, n ], [ this.userId, i, Number.POSITIVE_INFINITY ], 
        /*lowerOpen=*/ !0);
        return cr(t).W("collectionPathOverlayIndex", r).next((t => {
            for (const e of t) {
                const t = er(this.It, e);
                s.set(t.getKey(), t);
            }
            return s;
        }));
    ...
    ue(t, e) {
        return cr(t).put(function(t, e, n) {
            ...
            return {
                ...
                overlayMutation: Js(t.re, n.mutation)
            };
...
class ar {
    ...
    ae(t, e) {
        ...
        e.fe(t.booleanValue ? 1 : 0); else if ("integerValue" in t) this.le(e, 15), e.fe(se(t.integerValue)); else if ("doubleValue" in t) {
            const n = se(t.doubleValue);
            isNaN(n) ? this.le(e, 13) : (this.le(e, 15), le(n) ? 
        ...
        e.me(ie(t.bytesValue)), this.we(e); else if ("referenceValue" in t) this.ge(t.referenceValue, e); else if ("geoPointValue" in t) {
            const n = t.geoPointValue;
            this.le(e, 45), e.fe(n.latitude || 0), e.fe(n.longitude || 0);
        } else "mapValue" in t ? Se(t) ? this.le(e, Number.MAX_SAFE_INTEGER) : (this.ye(t.mapValue, e), 
        this.we(e)) : "arrayValue" in t ? (this.pe(t.arrayValue, e), this.we(e)) : U();
    }
    _e(t, e) {
 ...
 */ class wr {
    constructor() {
        this.Be = new fr, this.Le = new dr(this.Be), this.Ue = new _r(this.Be);
    }
    seed(t) {
        this.Be.seed(t);
    }
 ...
 */ class Ir {
    ...
    addToCollectionParentIndex(t, e) {
        return this.Ye.add(e), St.resolve();
    }
    getCollectionParents(t, e) {
        return St.resolve(this.Ye.getEntries(e));
    }
    addFieldIndex(t, e) {
...
class Ar {
    constructor(t, e) {
         ...
         */
        this.Ze = new cs((t => Be(t)), ((t, e) => Ue(t, e))), this.uid = t.uid || "";
    }
    /**
    ...
    getDocumentsMatchingTarget(t, e) {
        ...
        let s = !0;
        const i = new Map;
        return St.forEach(this.tn(e), (e => this.en(t, e).next((t => {
            s && (s = !!t), i.set(e, t);
        })))).next((() => {
            if (s) {
                let t = ps();
 ...
 */ (r, i), h = function(t, e) {
     ...
     */    rn(t, e, n, s, i, r, o) {
        ...
        for (let h = 0; h < u; ++h) {
            const u = e ? this.on(e[h / c]) : Er, l = this.un(t, u, n[h % c], s), f = this.cn(t, u, i[h % c], r), d = o.map((e => this.un(t, u, e, 
            /* inclusive= */ !0)));
    ...
    /** Encodes a single value to the ascending index format. */    on(t) {
        const e = new wr;
        return ar.Te.ce(t, e.qe(0 /* ASCENDING */)), e.$e();
    }
    /**
     ...
     */    hn(t, e) {
        const n = new wr;
        return ar.Te.ce(Ee(this.databaseId, e), n.qe(function(t) {
            const e = gt(t);
     ...
     */    sn(t, e, n) {
        ...
        for (const r of gt(t)) {
            const t = n[i++];
            for (const n of s) if (this.ln(e, r.fieldPath) && Re(t)) s = this.fn(s, r, t); else {
                const e = n.qe(r.kind);
                ar.Te.ce(t, e);
            }
        }
     ...
     */    fn(t, e, n) {
        ...
        for (const t of n.arrayValue.values || []) for (const n of s) {
            const s = new wr;
            s.seed(n.$e()), ar.Te.ce(t, s.qe(e.kind)), i.push(s);
        }
        return i;
    }
    ln(t, e) {
    ...
    updateCollectionGroup(t, e, n) {
        const s = Pr(t), i = vr(t);
        return this._n(t).next((t => s.W("collectionGroupIndex", IDBKeyRange.bound(e, e)).next((e => St.forEach(e, (e => i.put(sr(e.indexId, this.user, t, n))))))));
    }
    updateIndexEntries(t, e) {
        ...
        return St.forEach(e, ((e, s) => {
            ...
            St.forEach(i, (n => this.wn(t, e, n).next((e => {
                const i = this.mn(s, n);
                return e.isEqual(i) ? St.resolve() : this.gn(t, s, n, e, i);
            })))))));
        }));
    }
    yn(t, e, n, s) {
    ...
    pn(t, e, n, s) {
        return br(t).delete([ s.indexId, this.uid, s.arrayValue, s.directionalValue, this.hn(n, e.key), e.key.path.toArray() ]);
    }
    wn(t, e, n) {
        const s = br(t);
        let i = new zt(gr);
    ...
    /** Creates the index entries for the given document. */    mn(t, e) {
        ...
        if (null != i) {
            ...
            if (Re(r)) for (const i of r.arrayValue.values || []) n = n.add(new mr(e.indexId, t.key, this.on(i), s));
    ...
    getMinOffset(t, e) {
        return St.mapArray(this.tn(e), (e => this.en(t, e).next((t => t || U())))).next(Vr);
    }
}
...
class Nr {
    ...
    addMutationBatch(t, e, n, s) {
        ...
        return r.add({}).next((o => {
            ...
            const u = new Ui(o, e, n, s), c = function(t, e, n) {
                const s = n.baseMutations.map((e => Js(t.re, e))), i = n.mutations.map((e => Js(t.re, e)));
                return {
                    userId: e,
                    batchId: n.batchId,
    ...
    lookupMutationBatch(t, e) {
        return Mr(t).get(e).next((t => t ? (q(t.userId === this.userId), Yi(this.It, t)) : null));
    }
    /**
    ...
    // PORTING NOTE: Multi-tab only.
    Tn(t, e) {
        return this.In[e] ? St.resolve(this.In[e]) : this.lookupMutationBatch(t, e).next((t => {
            if (t) {
                const n = t.keys();
    ...
    getNextMutationBatchAfterBatchId(t, e) {
        ...
        return Mr(t).Z({
            ...
            e.userId === this.userId && (q(e.batchId >= n), i = Yi(this.It, e)), s.done();
        })).next((() => i));
    }
    ...
    getAllMutationBatches(t) {
        ...
        return Mr(t).W("userMutationsIndex", e).next((t => t.map((t => Yi(this.It, t)))));
    }
    getAllMutationBatchesAffectingDocumentKey(t, e) {
        ...
        return Or(t).Z({
            ...
            return Mr(t).get(c).next((t => {
                if (!t) throw U();
                q(t.userId === this.userId), i.push(Yi(this.It, t));
            }));
            r.done();
        })).next((() => i));
    }
    getAllMutationBatchesAffectingDocumentKeys(t, e) {
        ...
        const s = [];
        return e.forEach((e => {
            const i = gi(this.userId, e.path), r = IDBKeyRange.lowerBound(i), o = Or(t).Z({
                range: r
            }, ((t, s, i) => {
    ...
    En(t, e) {
        ...
        return e.forEach((e => {
            s.push(Mr(t).get(e).next((t => {
                if (null === t) throw U();
                q(t.userId === this.userId), n.push(Yi(this.It, t));
            })));
        })), St.waitFor(s).next((() => n));
    }
    removeMutationBatch(t, e) {
        return Cr(t.ie, this.userId, e).next((n => (t.addOnCommittedListener((() => {
            this.An(e.batchId);
 ...
 */ class Br {
    ...
    getLastRemoteSnapshotVersion(t) {
        return this.Vn(t).next((t => at.fromTimestamp(new ct(t.lastRemoteSnapshotVersion.seconds, t.lastRemoteSnapshotVersion.nanoseconds))));
    }
    ...
    removeTargetData(t, e) {
        return this.removeMatchingKeysForTargetId(t, e.targetId).next((() => Lr(t).delete(e.targetId))).next((() => this.Vn(t))).next((e => (q(e.targetCount > 0), 
 ...
 */ class Gr {
    constructor(t) {
        this.xn = t, this.buffer = new zt(Kr), this.Nn = 0;
    }
    kn() {
        return ++this.Nn;
    }
 ...
 */ class Qr {
    ...
    Fn(t) {
        F("LruGarbageCollector", `Garbage collection scheduled in ${t}ms`), this.On = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection" /* LruGarbageCollection */ , t, (async () => {
            this.On = null;
            try {
...
/** Implements the steps for LRU garbage collection. */ class jr {
    ...
    nthSequenceNumber(t, e) {
        if (0 === e) return St.resolve(Ut.at);
        const n = new Gr(e);
...
class Wr {
     ...
     */    Gn(t, e) {
        return function(t, e) {
            let n = !1;
            return Fr(t).tt((s => kr(t, s, e).next((t => (t && (n = !0), St.resolve(!t)))))).next((() => n));
        }(t, e);
    }
    removeOrphanedDocuments(t, e) {
 ...
 */ (e, n));
    ...
    getAllFromCollection(t, e, n) {
        ...
        return to(t).W(IDBKeyRange.bound(s, i, !0)).next((t => {
            let e = hs();
            for (const n of t) {
                const t = this.jn(_t.fromSegments(n.prefixPath.concat(n.collectionGroup, n.documentId)), n);
                e = e.insert(t.key, t);
            }
            return e;
        }));
    ...
    getAllFromCollectionGroup(t, e, n, s) {
        ...
        return to(t).Z({
            ...
            const r = this.jn(_t.fromSegments(e.prefixPath.concat(e.collectionGroup, e.documentId)), e);
 ...
 */ class Xr extends Hr {
    ...
    constructor(t, e) {
        ...
        // this buffer.
        this.Xn = new cs((t => t.toString()), ((t, e) => t.isEqual(e)));
    }
    applyChanges(t) {
        const e = [];
        ...
        return this.changes.forEach(((i, r) => {
            ...
            if (e.push(this.Yn.removeEntry(t, i, o.readTime)), r.isValidDocument()) {
                ...
                const n = Wi(this.Yn.It, r.convertToNoDocument(at.min()));
                e.push(this.Yn.addEntry(t, i, n));
            }
        })), s.forEach((n => {
            e.push(this.Yn.indexManager.addToCollectionParentIndex(t, n));
        })), e.push(this.Yn.updateMetadata(t, n)), St.waitFor(e);
    }
    getFromCache(t, e) {
 ...
 */ class oo {
    ...
    getBundleMetadata(t, e) {
        return St.resolve(this.Zn.get(e));
    }
    saveBundleMetadata(t, e) {
    ...
    getNamedQuery(t, e) {
        return St.resolve(this.ts.get(e));
    }
    saveNamedQuery(t, e) {
 ...
 */ class uo {
    constructor() {
        ...
        this.overlays = new Qt(_t.comparator), this.es = new Map;
    }
    getOverlay(t, e) {
    ...
    ue(t, e, n) {
        ...
        let i = this.es.get(e);
        void 0 === i && (i = ps(), this.es.set(e, i)), this.es.set(e, i.add(n.key));
    }
}
 ...
 */ class co {
    constructor() {
        ...
        this.ns = new zt(ao.ss), 
        // A set of outstanding references to a document sorted by target id.
        this.rs = new zt(ao.os);
    }
...
class ao {
    ...
    /** Compare by key then by ID */    static ss(t, e) {
        return _t.comparator(t.key, e.key) || rt(t._s, e._s);
    }
    /** Compare by ID then by key */    static os(t, e) {
        return rt(t._s, e._s) || _t.comparator(t.key, e.key);
    }
}
 ...
 */ class ho {
    ...
    getHighestUnacknowledgedBatchId() {
        return St.resolve(0 === this.mutationQueue.length ? -1 : this.ws - 1);
    }
    getAllMutationBatches(t) {
 ...
 */ class _o {
    constructor(t) {
         ...
         * IDs.
         */
        this.Ps = new co, this.targetCount = 0, this.vs = $r.Pn();
    }
    forEachTarget(t, e) {
        return this.Rs.forEach(((t, n) => e(n))), St.resolve();
    }
    getLastRemoteSnapshotVersion(t) {
        return St.resolve(this.lastRemoteSnapshotVersion);
    }
    getHighestSequenceNumber(t) {
        return St.resolve(this.bs);
    }
    allocateTargetId(t) {
        return this.highestTargetId = this.vs.next(), St.resolve(this.highestTargetId);
    }
    setTargetsMetadata(t, e, n) {
    ...
    Dn(t) {
        ...
        const e = t.targetId;
        e > this.highestTargetId && (this.vs = new $r(e), this.highestTargetId = e), t.sequenceNumber > this.bs && (this.bs = t.sequenceNumber);
    }
    addTargetData(t, e) {
        return this.Dn(e), this.targetCount += 1, St.resolve();
    }
    updateTargetData(t, e) {
        return this.Dn(e), St.resolve();
    }
    removeTargetData(t, e) {
    ...
    addMatchingKeys(t, e, n) {
        return this.Ps.us(e, n), St.resolve();
    }
    removeMatchingKeys(t, e, n) {
        this.Ps.hs(e, n);
    ...
    removeMatchingKeysForTargetId(t, e) {
        return this.Ps.ls(e), St.resolve();
    }
    getMatchingKeysForTargetId(t, e) {
    ...
    containsKey(t, e) {
        return St.resolve(this.Ps.containsKey(e));
    }
}
...
class wo {
     ...
     */
    constructor(t, e) {
        this.Vs = {}, this.overlays = {}, this.Ss = new Ut(0), this.Ds = !1, this.Ds = !0, 
        this.referenceDelegate = t(this), this.Cs = new _o(this);
        this.indexManager = new Ir, this.remoteDocumentCache = function(t) {
            return new lo(t);
        }((t => this.referenceDelegate.xs(t))), this.It = new Qi(e), this.Ns = new oo(this.It);
    }
    start() {
    ...
    getMutationQueue(t, e) {
        ...
        return n || (n = new ho(e, this.referenceDelegate), this.Vs[t.toKey()] = n), n;
    }
    getTargetCache() {
        return this.Cs;
    }
...
class go {
    ...
    addReference(t, e, n) {
        return this.Fs.addReference(n, e), this.Ls.delete(n.toString()), St.resolve();
    }
    removeReference(t, e, n) {
        return this.Fs.removeReference(n, e), this.Ls.add(n.toString()), St.resolve();
    }
    markPotentiallyOrphaned(t, e) {
        return this.Ls.add(e.toString()), St.resolve();
    }
    removeTarget(t, e) {
    ...
    Us(t, e) {
        return St.or([ () => St.resolve(this.Fs.containsKey(e)), () => this.persistence.getTargetCache().containsKey(t, e), () => this.persistence.Os(t, e) ]);
    }
}
 ...
 */
    ...
    qs(t) {
        ...
        return e.W().next((e => St.forEach(e, (e => {
            const s = IDBKeyRange.bound([ e.userId, -1 ], [ e.userId, e.lastAcknowledgedBatchId ]);
            return n.W("userMutationsIndex", s).next((n => St.forEach(n, (n => {
                q(n.userId === e.userId);
                const s = Yi(this.It, n);
 ...
 */            const u = {
    ...
    zs(t, e) {
        const n = e.store("mutations"), s = Yr(this.It), i = new wo(go.Bs, this.It.re);
        return n.W().next((t => {
            const n = new Map;
            return t.forEach((t => {
                var e;
                let s = null !== (e = n.get(t.userId)) && void 0 !== e ? e : ps();
                Yi(this.It, t).keys().forEach((t => s = s.add(t))), n.set(t.userId, s);
            })), St.forEach(n, ((t, n) => {
                const r = new x(n), o = ur.oe(this.It, r), u = i.getIndexManager(r), c = Nr.oe(r, this.It, u, i.referenceDelegate);
                return new ro(s, c, o, u).recalculateAndSaveOverlaysForDocumentKeys(new Bi(e, Ut.at), t).next();
            }));
        }));
    }
}
...
class To {
    ...
    a, h = 15) {
        ...
        this.si = t => Promise.resolve(), !To.C()) throw new j(Q.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
        this.referenceDelegate = new Wr(this, s), this.ii = e + "main", this.It = new Qi(u), 
        this.ri = new Ct(this.ii, this.Xs, new yo(this.It)), this.Cs = new Br(this.referenceDelegate, this.It), 
        this.remoteDocumentCache = Yr(this.It), this.Ns = new ir, this.window && this.window.localStorage ? this.oi = this.window.localStorage : (this.oi = null, 
     ...
     */    ui() {
        ...
        return Eo(t).get("owner").next((t => St.resolve(this.mi(t))));
    }
    gi(t) {
     ...
     */    di(t) {
        if (this.Ys) return St.resolve(!0);
        return Eo(t).get("owner").next((e => {
            ...
            return !(!this.networkEnabled || !this.inForeground) || Ao(t).W().next((t => void 0 === this.Ii(t, 5e3).find((t => {
     ...
     * PORTING NOTE: This is only used for Web multi-tab.
     */    vi() {
        return this.runTransaction("getActiveClients", "readonly", (t => Ao(t).W().next((t => this.Ii(t, 18e5).map((t => t.clientId))))));
    }
    get started() {
        return this.Ds;
    }
    getMutationQueue(t, e) {
        return Nr.oe(t, this.It, e, this.referenceDelegate);
    }
    getTargetCache() {
        return this.Cs;
    }
    ...
    getIndexManager(t) {
        return new Ar(t, this.It.re.databaseId);
    }
    getDocumentOverlayCache(t) {
        return ur.oe(this.It, t);
    }
    getBundleCache() {
        return this.Ns;
    }
    runTransaction(t, e, n) {
        ...
        const s = "readonly" === e ? "readonly" : "readwrite", i = 15 === (r = this.Xs) ? $i : 14 === r ? Fi : 13 === r ? Oi : 12 === r ? Mi : 11 === r ? ki : void U();
        /** Returns the object stores for the provided schema. */
        var r;
        let o;
        // Do all transactions as readwrite against all object stores, since we
        // are the only reader/writer.
                return this.ri.runTransaction(t, s, i, (s => (o = new Bi(s, this.Ss ? this.Ss.next() : Ut.at), 
        "readwrite-primary" === e ? this.fi(o).next((t => !!t || this.di(o))).next((e => {
            ...
            this.Hs.enqueueRetryable((() => this.si(!1))), new j(Q.FAILED_PRECONDITION, Pt);
            return n(o);
    ...
    Vi(t) {
        return Eo(t).get("owner").next((t => {
            if (null !== t && this.pi(t.leaseTimestampMs, 5e3) && !this.Ei(t.ownerId) && !this.mi(t) && !(this.Ys || this.allowTabSynchronization && t.allowTabSynchronization)) throw new j(Q.FAILED_PRECONDITION, Io);
        }));
    }
    /**
    ...
    /** Checks the primary lease and removes it if we are the current primary. */    _i(t) {
        const e = Eo(t);
        return e.get("owner").next((t => this.mi(t) ? (F("IndexedDbPersistence", "Releasing primary lease."), 
 ...
 */ class Po {
     ...
     */    ki(t, e) {
        ...
        e = mn(e, null, "F" /* First */), n = wn(e)), this.indexManager.getDocumentsMatchingTarget(t, n).next((s => {
            ...
            return this.Ni.getDocuments(t, i).next((s => this.indexManager.getMinOffset(t, n).next((n => {
                const r = this.Fi(e, s);
                return this.$i(e, r, i, n.readTime) ? this.ki(t, mn(e, null, "F" /* First */)) : this.Bi(t, r, e, n);
            }))));
        })))));
    }
    /**
     ...
     */    Mi(t, e, n, s) {
        return hn(e) || s.isEqual(at.min()) ? this.Oi(t, e) : this.Ni.getDocuments(t, n).next((i => {
            const r = this.Fi(e, i);
            return this.$i(e, r, n, s) ? this.Oi(t, e) : (M() <= u.DEBUG && F("QueryEngine", "Re-using previous result from %s to execute query: %s", s.toString(), pn(e)), 
            this.Bi(t, r, e, Et(s, -1)));
        }));
    ...
    Oi(t, e) {
        ...
        this.Ni.getDocumentsMatchingQuery(t, e, Rt.min());
    }
    /**
...
class vo {
    ...
    Qi(t) {
        ...
        this.mutationQueue = this.persistence.getMutationQueue(t, this.indexManager), this.localDocuments = new ro(this.Gi, this.mutationQueue, this.documentOverlayCache, this.indexManager), 
...
function Mo(t, e) {
    ...
    return n.persistence.runTransaction("Allocate target", "readwrite", (t => {
        ...
        s = i, St.resolve(s)) : n.Cs.allocateTargetId(t).next((i => (s = new Gi(e, i, 0 /* Listen */ , t.currentSequenceNumber), 
...
async function Oo(t, e, n) {
    const s = G(t), i = s.Ui.get(e), r = n ? "readwrite" : "readwrite-primary";
    try {
 ...
 */ function Fo(t, e, n) {
    ...
    return s.persistence.runTransaction("Execute query", "readonly", (t => function(t, e, n) {
        const s = G(t), i = s.qi.get(n);
        return void 0 !== i ? St.resolve(s.Ui.get(i)) : s.Cs.getTargetData(e, n);
    }(s, t, wn(e)).next((e => {
        if (e) return i = e.lastLimboFreeSnapshotVersion, s.Cs.getMatchingKeysForTargetId(t, e.targetId).next((t => {
            r = t;
        }));
    })).next((() => s.Li.getDocumentsMatchingQuery(t, e, n ? i : at.min(), n ? r : ps()))).next((t => (Lo(s, Tn(e), t), 
    {
        documents: t,
        Hi: r
    })))));
...
// PORTING NOTE: Multi-Tab only.
function $o(t, e) {
    const n = G(t), s = G(n.Cs), i = n.Ui.get(e);
...
// PORTING NOTE: Multi-Tab only.
function Bo(t, e) {
    const n = G(t), s = n.Ki.get(e) || at.min();
    // Get the current maximum read time for the collection. This should always
    // exist, but to reduce the chance for regressions we default to
    // SnapshotVersion.Min()
    // TODO(indexing): Consider removing the default value.
        return n.persistence.runTransaction("Get new document changes", "readonly", (t => n.Gi.getAllFromCollectionGroup(t, e, Et(s, -1), 
 ...
 */ class Yo {
    constructor(t, e, n, s, i) {
        ...
        this.ur = new Qt(rt), this.started = !1, 
        /**
        ...
        const r = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.window.localStorage, this.currentUser = i, this.ar = Ko(this.persistenceKey, this.sr), 
        this.hr = 
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ (this.persistenceKey), this.ur = this.ur.insert(this.sr, new Jo), this.lr = new RegExp(`^firestore_clients_${r}_([^_]*)$`), 
    ...
    rr(t) {
        ...
        if (e.storageArea === this.storage) {
            if (F("SharedClientState", "EVENT", e.key, e.newValue), e.key === this.ar) return void $("Received WebStorage notification for local change. Another client might have garbage-collected our state");
 ...
 */ (e.newValue);
                        t !== Ut.at && this.sequenceNumberHandler(t);
...
class Xo {
    constructor() {
        this.Lr = new Jo, this.Ur = {}, this.onlineStateHandler = null, this.sequenceNumberHandler = null;
    }
    addPendingMutation(t) {
        // No op.
    }
    ...
    start() {
        return this.Lr = new Jo, Promise.resolve();
    }
    handleUserChange(t, e, n) {
        // No op.
    }
...
class {
    ...
    co(t, e, n, s, i) {
        ...
        const o = {};
        return this.ho(o, s, i), this.lo(t, r, o, n).then((t => (F("RestConnection", "Received: ", t), 
        t)), (e => {
    ...
    _o(t, e, n) {
        const s = [ this.oo, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], i = b(), r = P(), o = {
        ...
        this.useFetchStreams && (o.xmlHttpFactory = new v({})), this.ho(o.initMessageHeaders, e, n), 
        ...
        // enough the code is exception free.
            ...
            h || (h = !0, F("Connection", "WebChannel transport closed"), l.io());
        })), f(c, V.EventType.ERROR, (t => {
            h || (h = !0, B("Connection", "WebChannel transport errored:", t), l.io(new j(Q.UNAVAILABLE, "The operation could not be completed")));
 ...
 */
                    ...
                    h = !0, l.io(new j(e, n)), c.close();
                } else F("Connection", "WebChannel received:", n), l.ro(n);
            }
        })), f(r, S.STAT_EVENT, (t => {
...
class uu {
     ...
     */    Ao(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                s > 0 && F("ExponentialBackoff", `Backing off for ${s} ms (base delay: ${this.po} ms, delay with jitter: ${e} ms, last attempt: ${n} ms ago)`), 
...
class cu {
    constructor(t, e, n, s, i, r, o, u) {
         ...
         * close.
         */
        this.So = 0, this.Do = null, this.Co = null, this.stream = null, this.xo = new uu(t, e);
    }
    /**
     ...
     */    async close(t, e) {
        ...
        this.xo.reset() : e && e.code === Q.RESOURCE_EXHAUSTED ? (
        // Log the error. (Probably either 'quota exceeded' or 'max queue length reached'.)
        $(e.toString()), $("Using maximum backoff delay to prevent overloading the backend."), 
        this.xo.Eo()) : e && e.code === Q.UNAUTHENTICATED && 3 /* Healthy */ !== this.state && (
     ...
     */    Ko(t) {
        return e => {
            this.Hs.enqueueAndForget((() => this.So === t ? e() : (F("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
            Promise.resolve())));
        };
    }
}
 ...
 */ class au extends cu {
    ...
    onMessage(t) {
        ...
        this.xo.reset();
        const e = Hs(this.It, t), n = function(t) {
     ...
     */    zo(t) {
        const e = {};
        e.database = Gs(this.It), e.addTarget = function(t, e) {
            let n;
            const s = e.target;
            return n = qe(s) ? {
                documents: Zs(t, s)
     ...
     */    Ho(t) {
        const e = {};
        e.database = Gs(this.It), e.removeTarget = t, this.Bo(e);
    }
}
 ...
 */ class hu extends cu {
    ...
    onMessage(t) {
        ...
        return q(!t.writeResults || 0 === t.writeResults.length), this.Jo = !0, this.listener.tu();
    }
    /**
...
class lu extends class {} {
    ...
    su() {
        if (this.nu) throw new j(Q.FAILED_PRECONDITION, "The client has already been terminated.");
    }
...
class fu {
    ...
    au(t) {
        ...
        this.ou ? ($(e), this.ou = !1) : F("OnlineStateTracker", e);
    }
    lu() {
        ...
        this.wu = [], this.mu = i, this.mu.qr((t => {
            n.enqueueAndForget((async () => {
                ...
                await async function(t) {
                    const e = G(t);
                    e._u.add(4 /* ConnectivityChange */), await wu(e), e.gu.set("Unknown" /* Unknown */), 
                    e._u.delete(4 /* ConnectivityChange */), await _u(e);
                }(this));
            }));
        })), this.gu = new fu(n, s);
    }
...
async function _u(t) {
    if (Eu(t)) for (const e of t.wu) await e(/* enabled= */ !0);
}
 ...
 */ function gu(t, e) {
    const n = G(t), s = Lu(n);
    n.du.delete(e), s.ko() && pu(n, e), 0 === n.du.size && (s.ko() ? s.Fo() : Eu(n) && 
 ...
 */ function Tu(t) {
    return Eu(t) && !Lu(t).No() && t.du.size > 0;
}
 ...
 */ (t, e);
        ...
        await vu(t, n);
    } else if (e instanceof Rs ? t.yu.Gt(e) : e instanceof bs ? t.yu.Yt(e) : t.yu.Wt(e), 
 ...
 */
        function(t, e) {
            ...
            n.targetMismatches.forEach((e => {
                ...
                // state.
                                t.du.set(e, n.withResumeToken(te.EMPTY_BYTE_STRING, n.snapshotVersion)), 
 ...
 */ async function vu(t, e, n) {
    ...
    await wu(t), t.gu.set("Offline" /* Offline */), n || (
    ...
    t.asyncQueue.enqueueRetryable((async () => {
        F("RemoteStore", "Retrying IndexedDB access"), await n(), t._u.delete(1 /* IndexedDbFailed */), 
        await _u(t);
    }));
}
...
function xu(t) {
    return Eu(t) && !Uu(t).No() && t.fu.length > 0;
}
...
async function Ou(t, e, n) {
    const s = t.fu.shift(), i = qi.from(s, e, n);
...
async function Fu(t, e) {
    ...
    await async function(t, e) {
        ...
        if (n = e.code, os(n) && n !== Q.ABORTED) {
            ...
            // restart.
                        Uu(t).Oo(), await Vu(t, (() => t.remoteSyncer.rejectFailedWrite(n.batchId, e))), 
...
async function $u(t, e) {
    ...
    // new mutations from the LocalStore (since mutations are per-user).
        n._u.add(3 /* CredentialChange */), await wu(n), s && 
    // Don't set the network status to Unknown if we are offline.
    n.gu.set("Unknown" /* Unknown */), await n.remoteSyncer.handleCredentialChange(e), 
    n._u.delete(3 /* CredentialChange */), await _u(n);
}
 ...
 */ async function Bu(t, e) {
    const n = G(t);
    e ? (n._u.delete(2 /* IsSecondary */), await _u(n)) : e || (n._u.add(2 /* IsSecondary */), 
    await wu(n), n.gu.set("Unknown" /* Unknown */));
}
 ...
 */ function Lu(t) {
    ...
    t.pu = function(t, e, n) {
        const s = G(t);
        return s.su(), new au(e, s.Vo, s.authCredentials, s.appCheckCredentials, s.It, n);
    }
    /**
 * @license
 * Copyright 2018 Google LLC
 ...
 */ (t.datastore, t.asyncQueue, {
        ...
        e ? (t.pu.Oo(), Tu(t) ? Iu(t) : t.gu.set("Unknown" /* Unknown */)) : (await t.pu.stop(), 
        Au(t));
    }))), t.pu;
}
 ...
 */ function Uu(t) {
    ...
    t.Iu = function(t, e, n) {
        const s = G(t);
        return s.su(), new hu(e, s.Vo, s.authCredentials, s.appCheckCredentials, s.It, n);
    }(t.datastore, t.asyncQueue, {
        Yr: ku.bind(null, t),
        Zr: Fu.bind(null, t),
        tu: Mu.bind(null, t),
        ...
        await Su(t)) : (await t.Iu.stop(), t.fu.length > 0 && (F("RemoteStore", `Stopping write stream with ${t.fu.length} pending writes`), 
        t.fu = []));
    }))), t.Iu;
}
 ...
 */ class tc {
    ...
    xu(t) {
        t = ju.fromInitialDocuments(t.query, t.docs, t.mutatedKeys, t.fromCache), this.Vu = !0, 
        this.vu.next(t);
    }
}
 ...
 */ class nc {
     ...
     */    Yi(t) {
        return t.metadata.exists ? Ws(this.It, t.document, !1) : Oe.newNoDocument(this.Ji(t.metadata.name), this.Xi(t.metadata.readTime));
    }
    Xi(t) {
        return Fs(t);
    }
 ...
 */ class sc {
    ...
    Fu(t) {
        const e = new Map, n = new nc(this.It);
     ...
     */    async complete() {
        const t = await Uo(this.localStore, new nc(this.It), this.documents, this.Mu.id), e = this.Fu(this.documents);
 ...
 */ class uc {
    ...
    e) {
        ...
        this.mutatedKeys = ps(), this.Ku = En(t), this.Gu = new Gu(this.Ku);
    }
    /**
     ...
     */    ju(t, e) {
        const n = e ? e.Wu : new Qu, s = e ? e.Gu : this.Gu;
 ...
 */ (t.type, e.type) || this.Ku(t.doc, e.doc))), this.Hu(n);
        ...
        if (this.Uu = o, 0 !== i.length || u) {
            return {
                snapshot: new ju(this.query, t.Gu, s, i, t.mutatedKeys, 0 /* Local */ === o, u, 
                /* excludesMetadataChanges= */ !1),
                Yu: r
            };
        }
    ...
    Ju() {
        ...
        // updating many documents.
                const t = this.qu;
        this.qu = ps(), this.Gu.forEach((t => {
            this.Xu(t.key) && (this.qu = this.qu.add(t.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        const e = [];
        return t.forEach((t => {
            this.qu.has(t) || e.push(new oc(t));
        })), this.qu.forEach((n => {
    ...
    // PORTING NOTE: Multi-tab only.
    tc() {
        return ju.fromInitialDocuments(this.query, this.Gu, this.mutatedKeys, 0 /* Local */ === this.Uu);
    }
}
 ...
 */ class hc {
    ...
    s, i, r) {
        ...
        this.currentUser = i, this.maxConcurrentLimboResolutions = r, this.nc = {}, this.sc = new cs((t => yn(t)), gn), 
        this.ic = new Map, 
        /**
         ...
         * active target.
         */
        this.oc = new Qt(_t.comparator), 
        /**
         * Keeps track of the information about an active limbo resolution for each
         * active target ID that was started for the purpose of limbo resolution.
         */
        this.uc = new Map, this.cc = new co, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.ac = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.hc = new Map, this.lc = $r.vn(), this.onlineState = "Unknown" /* Unknown */ , 
 ...
 */ async function fc(t, e, n, s) {
    ...
    t.dc = (e, n, s) => async function(t, e, n, s) {
        ...
        return bc(t, e.targetId, o.Yu), o.snapshot;
    }(t, e, n, s);
    const i = await Fo(t.localStore, e, 
    /* usePreviousResults= */ !0), r = new uc(e, i.Hi), o = r.ju(i.documents), u = As.createSynthesizedTargetChangeForCurrentChange(n, s && "Offline" /* Offline */ !== t.onlineState), c = r.applyChanges(o, 
...
/** Stops listening to the query. */ async function dc(t, e) {
    const n = G(t), s = n.sc.get(e), i = n.ic.get(s.targetId);
    if (i.length > 1) return n.ic.set(s.targetId, i.filter((t => !gn(t, e)))), void n.sc.delete(e);
 ...
 */ async function wc(t, e) {
    ...
    try {
        ...
        // Update `receivedDocument` as appropriate for any limbo targets.
            ...
            t.addedDocuments.size > 0 ? s.ec = !0 : t.modifiedDocuments.size > 0 ? q(s.ec) : t.removedDocuments.size > 0 && (q(s.ec), 
            s.ec = !1));
        })), await Vc(n, t, e);
    } catch (t) {
        await Vt(t);
 ...
 */ async function gc(t, e, n) {
    ...
    if (r) {
        ...
        s.oc = s.oc.remove(r), s.uc.delete(e), vc(s);
...
function Rc(t, e) {
    ...
    const n = t.oc.get(e);
    null !== n && (gu(t.remoteStore, n), t.oc = t.oc.remove(e), t.uc.delete(n), vc(t));
}

function bc(t, e, n) {
    for (const s of n) if (s instanceof rc) t.cc.addReference(s.key, e), Pc(t, s); else if (s instanceof oc) {
        F("SyncEngine", "Document no longer in limbo: " + s.key), t.cc.removeReference(s.key, e);
...
function Pc(t, e) {
    ...
    t.oc.get(n) || t.rc.has(s) || (F("SyncEngine", "New document in limbo: " + n), t.rc.add(s), 
    vc(t));
}
 ...
 */ function vc(t) {
    for (;t.rc.size > 0 && t.oc.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.rc.delete(e);
        const n = new _t(lt.fromString(e)), s = t.lc.next();
        t.uc.set(s, new ac(n)), t.oc = t.oc.insert(n, s), mu(t.remoteStore, new Gi(wn(an(n.path)), s, 2 /* LimboResolution */ , Ut.at));
    }
}
...
async function Vc(t, e, n) {
    ...
    s.sc.isEmpty() || (s.sc.forEach(((t, u) => {
        ...
        const n = G(t);
        try {
            await n.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (t => St.forEach(e, (e => St.forEach(e.Si, (s => n.persistence.referenceDelegate.addReference(t, e.targetId, s))).next((() => St.forEach(e.Di, (s => n.persistence.referenceDelegate.removeReference(t, e.targetId, s)))))))));
        } catch (t) {
            if (!kt(t)) throw t;
...
async function Sc(t, e) {
    ...
    if (!n.currentUser.isEqual(e)) {
        ...
        n.sharedClientState.handleUserChange(e, t.removedBatchIds, t.addedBatchIds), await Vc(n, t.ji);
    }
}

function Dc(t, e) {
    const n = G(t), s = n.uc.get(e);
    if (s && s.ec) return ps().add(s.key);
    {
        let t = ps();
        const s = n.ic.get(e);
        if (!s) return t;
 ...
 */ async function Cc(t, e) {
    ...
    return n.isPrimaryClient && bc(n, e.targetId, i.Yu), i;
}
...
async function Nc(t, e, n, s) {
    const i = G(t), r = await function(t, e) {
        ...
        return n.persistence.runTransaction("Lookup mutation documents", "readonly", (t => s.Tn(t, e).next((e => e ? n.localDocuments.getDocuments(t, e) : St.resolve(null)))));
    }
    // PORTING NOTE: Multi-Tab only.
    (i.localStore, e);
    null !== r ? ("pending" === n ? 
...
async function kc(t, e) {
    ...
    if (Lc(n), Uc(n), !0 === e && !0 !== n.fc) {
        ...
        n.fc = !0, await Bu(n.remoteStore, !0);
        ...
        function(t) {
            ...
            e.uc.forEach(((t, n) => {
                gu(e.remoteStore, n);
            })), e.cc.fs(), e.uc = new Map, e.oc = new Qt(_t.comparator);
        }
        /**
 ...
 */
        // PORTING NOTE: Multi-Tab only.
        (n), n.fc = !1, await Bu(n.remoteStore, !1);
    }
}
...
async function Mc(t, e, n) {
    ...
    for (const t of e) {
        ...
        if (n && 0 !== n.length) {
            ...
            for (const t of n) {
                const e = s.sc.get(t), n = await Cc(s, e);
...
function Fc(t) {
    const e = G(t);
    return G(G(e.localStore).persistence).vi();
}
...
function Lc(t) {
    ...
    e.remoteStore.remoteSyncer.rejectListen = gc.bind(null, e), e.nc.Wo = Yu.bind(null, e.eventManager), 
    e.nc._c = Xu.bind(null, e.eventManager), e;
}
 ...
 */ (t.localStore, s)) return await e.close(), n._completeWith(function(t) {
            ...
            const i = new sc(s, t.localStore, e.It);
            let r = await e.wc();
            for (;r; ) {
...
class Kc {
    ...
    async initialize(t) {
        this.It = ou(t.databaseInfo.databaseId), this.sharedClientState = this.mc(t), this.persistence = this.gc(t), 
    ...
    yc(t) {
        return Vo(this.persistence, new Po, t.initialUser, this.It);
    }
    gc(t) {
        return new wo(go.Bs, this.It);
    }
    mc(t) {
        return new Xo;
    }
 ...
 */ class Gc extends Kc {
    ...
    async initialize(t) {
        ...
        await Uc(this.Ec.syncEngine), await Su(this.Ec.remoteStore), 
    ...
    gc(t) {
        ...
        return new To(this.synchronizeTabs, e, t.clientId, n, t.asyncQueue, iu(), ru(), this.It, this.sharedClientState, !!this.forceOwnership);
    }
    mc(t) {
        return new Xo;
    }
 ...
 */ class Qc extends Gc {
    ...
    async initialize(t) {
        ...
        await this.persistence.li((async t => {
            await kc(this.Ec.syncEngine, t), this.gcScheduler && (t && !this.gcScheduler.started ? this.gcScheduler.start() : t || this.gcScheduler.stop()), 
    ...
    mc(t) {
        const e = iu();
        if (!Yo.C(e)) throw new j(Q.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
 ...
 */ class jc {
    ...
    createRemoteStore(t) {
        ...
        r = tu.C() ? new tu : new Zo, new du(e, n, s, i, r);
        var e, n, s, i, r;
    ...
    terminate() {
        return async function(t) {
            const e = G(t);
            F("RemoteStore", "RemoteStore shutting down."), e._u.add(5 /* Shutdown */), await wu(e), 
            e.mu.shutdown(), 
...
class zc {
    ...
    error(t) {
        this.observer.error ? this.Ac(this.observer.error, t) : $("Uncaught Error in snapshot listener:", t);
    }
    Rc() {
        this.muted = !0;
    }
...
class Jc {
    ...
    async lookup(t) {
        ...
        const e = await async function(t, e) {
            const n = G(t), s = Gs(n.It) + "/documents", i = {
                documents: e.map((t => Ls(n.It, t)))
 ...
 */ class Yc {
    constructor(t, e, n, s, i) {
        ...
        this.deferred = i, this.Nc = n.maxAttempts, this.xo = new uu(this.asyncQueue, "transaction_retry" /* TransactionRetry */);
    }
    ...
    kc() {
        this.xo.Ao((async () => {
            const t = new Jc(this.datastore), e = this.Mc(t);
            e && e.then((e => {
...
class Xc {
    ...
    n, s) {
        ...
        this.user = x.UNAUTHENTICATED, this.clientId = it.R(), this.authCredentialListener = () => Promise.resolve(), 
...
/** Enables the network connection and re-enqueues all pending operations. */ function ca(t) {
    return t.asyncQueue.enqueue((async () => {
        ...
        return e.setNetworkEnabled(!0), function(t) {
            const e = G(t);
            return e._u.delete(0 /* UserDisabled */), _u(e);
        }(n);
    }));
}
...
/** Disables the network connection. Pending operations will not complete. */ function aa(t) {
    return t.asyncQueue.enqueue((async () => {
        ...
        return e.setNetworkEnabled(!1), async function(t) {
            const e = G(t);
            e._u.add(0 /* UserDisabled */), await wu(e), 
...
function fa(t, e) {
    ...
    return t.asyncQueue.enqueueAndForget((async () => async function(t, e, n) {
        try {
            ...
            /* usePreviousResults= */ !0), i = new uc(e, s.Hi), r = i.ju(s.documents), o = i.applyChanges(r, 
            /* updateLimboDocuments= */ !1);
...
function ka(t, e, ...n) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = it.R()), pa("doc", "path", e), t instanceof va) {
        const s = lt.fromString(e, ...n);
 ...
 */ class Fa {
    constructor() {
        ...
        this.xo = new uu(this, "async_queue_retry" /* AsyncQueueRetry */), 
        // Visibility handler that triggers an immediate retry of all retryable
        // operations. Meant to speed up recovery when we regain file system access
        // after page comes into foreground.
        this.jc = () => {
            const t = ru();
            t && F("AsyncQueue", "Visibility state changed to " + t.visibilityState), this.xo.bo();
        };
        const t = ru();
 ...
 */ (t);
    ...
    enqueueAfterDelay(t, e, n) {
        ...
        const s = qu.createAndSchedule(this, t, e, n, (t => this.Jc(t)));
...
function Ha(t) {
    ...
    return t._queue.enqueueAndForgetEvenWhileRestricted((async () => {
        try {
            await async function(t) {
                if (!Ct.C()) return Promise.resolve();
                const e = t + "main";
                await Ct.delete(e);
            }
            /**
...
/** A "context" object passed around while parsing user data. */ class fh {
    ...
    /** Returns a new context with the specified settings overwritten. */    sa(t) {
        return new fh(Object.assign(Object.assign({}, this.settings), t), this.databaseId, this.It, this.ignoreUndefinedProperties, this.fieldTransforms, this.fieldMask);
    }
    ia(t) {
        var e;
    ...
    aa(t) {
        return xh(t, this.settings.methodName, this.settings.ha || !1, this.path, this.settings.la);
    }
    ...
    oa(t) {
        ...
        if (lh(this.na) && ch.test(t)) throw this.aa('Document fields cannot begin and end with "__"');
    }
}
 ...
 */ class dh {
    constructor(t, e, n) {
        this.databaseId = t, this.ignoreUndefinedProperties = e, this.It = n || ou(t);
    }
...
class ph extends oh {
    ...
    _toFieldTransform(t) {
        const e = gh(this, t, 
        /*array=*/ !0), n = this.da.map((t => bh(t, e))), s = new xn(n);
...
class Ih extends oh {
    ...
    _toFieldTransform(t) {
        const e = gh(this, t, 
        /*array=*/ !0), n = this.da.map((t => bh(t, e))), s = new kn(n);
        return new Bn(t.path, s);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
class Th extends oh {
    ...
    _toFieldTransform(t) {
        const e = new On(t.It, Pn(t.It, this._a));
...
/** Parse update data from a list of field/value arguments. */ function Ah(t, e, n, s, i, r) {
    const o = t.fa(1 /* Update */ , e, n), u = [ Sh(e, s, n) ], c = [ i ];
 ...
 */ function Rh(t, e, n, s = !1) {
    return bh(n, t.fa(s ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */
    return function(t, e) {
        ...
        if (!lh(e.na)) throw e.aa(`${t._methodName}() can only be used with update() and set()`);
 ...
 */ (t, e), null;
    ...
    return function(t, e) {
        ...
        if (t instanceof rh) return {
            bytesValue: Ms(e.It, t._byteString)
        };
        if (t instanceof Sa) {
        ...
        throw e.aa(`Unsupported field value: ${Aa(t)}`);
    }
    /**
...
class Jh extends Gh {
    ...
    _apply(t) {
        return new Da(t.firestore, t.converter, mn(t._query, this.pa, this.Ia));
    }
}
...
class Zh extends Gh {
    ...
    _apply(t) {
        const e = rl(t, this.type, this.Ta, this.Ea);
        return new Da(t.firestore, t.converter, function(t, e) {
...
function Pl(t, ...e) {
    ...
    return function(t, e, n, s) {
        ...
        return t.asyncQueue.enqueueAndForget((async () => Hu(await ua(t), r))), () => {
            i.Rc(), t.asyncQueue.enqueueAndForget((async () => Ju(await ua(t), r)));
        };
    }(Ga(a), h, u, c);
}
